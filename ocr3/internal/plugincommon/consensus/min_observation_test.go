...
func Test_CommitReportValidator_ExecutePluginCommitData(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			validator := consensus2.NewMinObservation[exectypes.CommitData](tt.min, idFunc)
			...
			oracleValidator := consensus2.NewOracleMinObservation[exectypes.CommitData](tt.min, idFunc)
...
func Test_CommitReportValidator_Generics(t *testing.T) {
	...
	validator := consensus2.NewMinObservation[Generic](2, idFunc)
	...
	oracleValidator := consensus2.NewOracleMinObservation[Generic](2, idFunc)
