...
import (
	...
	"github.com/smartcontractkit/chainlink-ccip/ocr3/execute/exectypes"
	slicelib2 "github.com/smartcontractkit/chainlink-ccip/ocr3/internal/libs/slicelib"
)
...
func buildSingleChainReportHelper(
	...
	finalReport := ccipocr3.ExecutePluginReportSingleChain{
		...
		Proofs:              proofsCast,
		ProofFlagBits:       ccipocr3.BigInt{Int: slicelib2.BoolsToBitFlags(proof.SourceFlags)},
	}
...
func (b *execReportBuilder) extractReadyMessages(
	ctx context.Context,
	report exectypes.CommitData) (map[int]struct{}, error) {
	readyMessages := make(map[int]struct{})
	for i := 0; i < len(report.Messages); i++ {
...
func (b *execReportBuilder) buildSingleChainReport(
	...
	finalize := func(
		...
		b.lggr.Infow("messages added to report",
			"messageIDs", slicelib2.Map(execReport.Messages, func(m ccipocr3.Message) ccipocr3.Bytes32 {
				return m.Header.MessageID
			}),
			"seqNums", slicelib2.Map(execReport.Messages, func(m ccipocr3.Message) ccipocr3.SeqNum {
				return m.Header.SequenceNumber
			}),
			"senders", slicelib2.Map(execReport.Messages, func(m ccipocr3.Message) ccipocr3.UnknownAddress {
				return m.Sender
			}),
			"nonces", slicelib2.Map(execReport.Messages, func(m ccipocr3.Message) uint64 {
