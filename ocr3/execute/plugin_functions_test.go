...
func Test_validateObserverReadingEligibility(t *testing.T) {
	tests := []struct {
		...
		observedMsgs exectypes2.MessageObservations
		expErr       string
	}{
		{
...
func Test_validateObservedSequenceNumbers(t *testing.T) {
	testCases := []struct {
		name         string
		observedData map[cciptypes.ChainSelector][]exectypes2.CommitData
		expErr       bool
	}{
		{
			name: "ValidData",
...
func Test_computeRanges(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name: "empty",
			args: args{reports: []exectypes2.CommitData{}},
			want: nil,
		},
		{
...
func Test_groupByChainSelectorWithFilter(t *testing.T) {
	...
	tests := []struct {
		name string
		args args
		want exectypes2.CommitObservations
	}{
		{
			name: "empty",
			args: args{
...
func Test_combineReportsAndMessages(t *testing.T) {
	...
	tests := []struct {
		name         string
		args         args
		wantPending  []exectypes2.CommitData
		wantExecuted []exectypes2.CommitData
	}{
		{
			name: "empty",
			args: args{
...
func Test_decodeAttributedObservations(t *testing.T) {
	mustEncode := func(obs exectypes2.Observation) []byte {
	...
	tests := []struct {
		...
		want    []plugincommon.AttributedObservation[exectypes2.Observation]
			...
			args: []types.AttributedObservation{
				{
					...
					Observation: mustEncode(exectypes2.Observation{
						CommitReports: exectypes2.CommitObservations{
...
func Test_computeConsensusObservation(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			args: args{
				observation: []exectypes2.Observation{
					{
						Nonces: exectypes2.NonceObservations{dstChain: {"0x1": 1}},
		...
		},
		{
			...
			want:    exectypes2.Observation{Nonces: exectypes2.NonceObservations{}},
			wantErr: assert.NoError,
		},
		{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			var ao []plugincommon.AttributedObservation[exectypes2.Observation]
			for i, observation := range tt.args.observation {
				ao = append(ao, plugincommon.AttributedObservation[exectypes2.Observation]{
...
func Test_computeTokenDataObservationsConsensus(t *testing.T) {
	...
	tt := []struct {
		name                   string
		F                      int
		observation            []map[cciptypes.SeqNum]exectypes2.MessageTokenData
			...
			observation: []map[cciptypes.SeqNum]exectypes2.MessageTokenData{
				{
					...
					2: exectypes2.NewMessageTokenData(),
					3: exectypes2.NewMessageTokenData(),
				},
				{
					1: exectypes2.NewMessageTokenData(),
					2: exectypes2.NewMessageTokenData(),
		...
		},
		{
			...
			observation: []map[cciptypes.SeqNum]exectypes2.MessageTokenData{
				{
					1: exectypes2.NewMessageTokenData(
						exectypes2.NewSuccessTokenData([]byte{11}),
						exectypes2.NewNoopTokenData(),
					),
					2: exectypes2.NewMessageTokenData(),
					3: exectypes2.NewMessageTokenData(
						exectypes2.NewSuccessTokenData([]byte{31}),
					),
					5: exectypes2.NewMessageTokenData(
						exectypes2.NewSuccessTokenData([]byte{51}),
						exectypes2.NewSuccessTokenData([]byte{52}),
					),
				},
				{
					1: exectypes2.NewMessageTokenData(
					...
					3: exectypes2.NewMessageTokenData(
						exectypes2.NewSuccessTokenData([]byte{31}),
						exectypes2.NewSuccessTokenData([]byte{32}),
						exectypes2.NewSuccessTokenData([]byte{33}),
					),
					4: exectypes2.NewMessageTokenData(
						exectypes2.NewSuccessTokenData([]byte{41}),
						exectypes2.NewSuccessTokenData([]byte{42}),
					),
					5: exectypes2.NewMessageTokenData(
						exectypes2.NewSuccessTokenData([]byte{51}),
						exectypes2.NewSuccessTokenData([]byte{52}),
			...
			observation: []map[cciptypes.SeqNum]exectypes2.MessageTokenData{
				{
					1: exectypes2.NewMessageTokenData(
						exectypes2.NewSuccessTokenData([]byte{11}),
						exectypes2.NewNoopTokenData(),
						exectypes2.NewSuccessTokenData([]byte{13}),
					),
				},
				{
					1: exectypes2.NewMessageTokenData(
				...
				},
				{
					1: exectypes2.NewMessageTokenData(
						exectypes2.NewSuccessTokenData([]byte{11}),
						exectypes2.NewSuccessTokenData([]byte{12}),
						exectypes2.NewSuccessTokenData([]byte{13}),
					),
				},
			},
			...
			observation: []map[cciptypes.SeqNum]exectypes2.MessageTokenData{
				{
					1: exectypes2.NewMessageTokenData(
						exectypes2.NewNoopTokenData(),
						exectypes2.NewSuccessTokenData([]byte{2}),
						exectypes2.NewErrorTokenData(fmt.Errorf("error")),
					),
				},
				{
					1: exectypes2.NewMessageTokenData(
						exectypes2.NewSuccessTokenData([]byte{1}),
						exectypes2.NewSuccessTokenData([]byte{2}),
						exectypes2.NewErrorTokenData(fmt.Errorf("error")),
					),
				},
				{
					1: exectypes2.NewMessageTokenData(
						exectypes2.NewNoopTokenData(),
						exectypes2.NewSuccessTokenData([]byte{2}),
						exectypes2.NewSuccessTokenData([]byte{3}),
					),
				},
			},
			expected: map[cciptypes.SeqNum]expected{
			...
			observation: []map[cciptypes.SeqNum]exectypes2.MessageTokenData{
				{
					1: exectypes2.NewMessageTokenData(
						exectypes2.NewNoopTokenData(),
						exectypes2.NewSuccessTokenData([]byte{2}),
						exectypes2.NewErrorTokenData(fmt.Errorf("error1")),
					),
				},
				{
					1: exectypes2.NewMessageTokenData(
						exectypes2.NewSuccessTokenData([]byte{1}),
						exectypes2.NewNoopTokenData(),
						exectypes2.NewErrorTokenData(fmt.Errorf("error2")),
					),
				},
				{
					1: exectypes2.NewMessageTokenData(
			...
			observation: []map[cciptypes.SeqNum]exectypes2.MessageTokenData{
				{
					...
					2: exectypes2.NewMessageTokenData(
						exectypes2.NewSuccessTokenData([]byte{90}),
					),
				},
				{
					1: exectypes2.NewMessageTokenData(
		...
		},
		{
			...
			observation: []map[cciptypes.SeqNum]exectypes2.MessageTokenData{
				...
				},
				{
					...
					2: exectypes2.NewMessageTokenData(
						exectypes2.NewSuccessTokenData([]byte{4}),
					),
				},
				{
					1: exectypes2.NewMessageTokenData(
		...
		},
		{
			...
			observation: []map[cciptypes.SeqNum]exectypes2.MessageTokenData{
				{
					1: exectypes2.NewMessageTokenData(
						exectypes2.TokenData{Ready: true, Data: []byte{1}},
					),
					2: exectypes2.NewMessageTokenData(
						exectypes2.TokenData{Ready: true, Data: []byte{2}, Supported: true},
					),
					3: exectypes2.NewMessageTokenData(
						exectypes2.TokenData{Ready: true, Data: []byte{3}, Supported: false},
					),
				},
				{
					1: exectypes2.NewMessageTokenData(
						exectypes2.TokenData{Ready: true, Data: []byte{2}},
					),
					2: exectypes2.NewMessageTokenData(
						exectypes2.TokenData{Ready: true, Data: []byte{2}, Supported: false},
					),
					3: exectypes2.NewMessageTokenData(
						exectypes2.TokenData{Ready: true, Data: []byte{3}, Supported: false, Error: fmt.Errorf("error")},
					),
				},
			},
			expected: map[cciptypes.SeqNum]expected{
	...
	for _, tc := range tt {
		t.Run(tc.name, func(t *testing.T) {
			...
			for i, observation := range tc.observation {
				formatted := make(exectypes2.TokenDataObservations)
...
func Test_validateCommitReportsReadingEligibility(t *testing.T) {
	tests := []struct {
		...
		observedData    exectypes2.CommitObservations
		expErr          string
	}{
		{
...
func Test_computeNoncesConsensus(t *testing.T) {
	...
	testCases := []struct {
		name                 string
		allNonceObservations []exectypes2.NonceObservations
		fChain               int
		expNonceConsensus    exectypes2.NonceObservations
	}{
		{
			name:                 "empty",
			allNonceObservations: []exectypes2.NonceObservations{},
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			observations := make([]plugincommon.AttributedObservation[exectypes2.Observation], len(tc.allNonceObservations))
			for i, obs := range tc.allNonceObservations {
				observations[i] = plugincommon.AttributedObservation[exectypes2.Observation]{
					Observation: exectypes2.Observation{Nonces: obs},
					OracleID:    commontypes.OracleID(i),
				}
			}
...
func Test_computeMessageHashesConsensus(t *testing.T) {
	testCases := []struct {
		...
		expectedHashes exectypes2.MessageHashes
		fChain         map[cciptypes.ChainSelector]int
	}{
		{
			name: "empty",
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			observations := make([]plugincommon.AttributedObservation[exectypes2.Observation], len(tc.observations))
			for i, obs := range tc.observations {
				observations[i] = plugincommon.AttributedObservation[exectypes2.Observation]{
					Observation: exectypes2.Observation{Hashes: obs},
					OracleID:    commontypes.OracleID(i),
				}
			}
...
func Test_computeCommitObservationsConsensus(t *testing.T) {
	...
	baseObservation := map[cciptypes.ChainSelector][]exectypes2.CommitData{
		1: {
			{
				SourceChain:         1,
	...
	baseObservationDifferentOnRamp := map[cciptypes.ChainSelector][]exectypes2.CommitData{
		1: {
			{
				SourceChain:         1,
	...
	testCases := []struct {
		name         string
		observations []exectypes2.CommitObservations
		exp          exectypes2.CommitObservations
		fChain       map[cciptypes.ChainSelector]int
	}{
		{
			name:         "empty",
			observations: []exectypes2.CommitObservations{},
			exp:          exectypes2.CommitObservations(nil),
			fChain:       map[cciptypes.ChainSelector]int{},
		},
		{
		...
		},
		{
			...
			exp: map[cciptypes.ChainSelector][]exectypes2.CommitData{
				1: {
					{
						SourceChain:         1,
						OnRampAddress:       []byte{5, 6, 7},
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			for i, obs := range tc.observations {
				observations[i] = plugincommon.AttributedObservation[exectypes2.Observation]{
					Observation: exectypes2.Observation{CommitReports: obs},
					OracleID:    commontypes.OracleID(i),
				}
			}
...
func Test_computeMessageObservationsConsensus(t *testing.T) {
	msgWithID9 := exectypes2.MessageObservations{1: map[cciptypes.SeqNum]cciptypes.Message{
	...
	msgWithID2 := exectypes2.MessageObservations{1: map[cciptypes.SeqNum]cciptypes.Message{
		1000: {Header: cciptypes.RampMessageHeader{SequenceNumber: 1000,
	...
	testCases := []struct {
		...
		exp          exectypes2.MessageObservations
		fChain       map[cciptypes.ChainSelector]int
	}{
		{
			name:         "empty",
			observations: []exectypes2.MessageObservations{},
			exp:          exectypes2.MessageObservations(nil),
			fChain:       map[cciptypes.ChainSelector]int{},
		},
		{
			name: "base scenario reaching consensus",
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			for i, obs := range tc.observations {
				observations[i] = plugincommon.AttributedObservation[exectypes2.Observation]{
					Observation: exectypes2.Observation{Messages: obs},
					OracleID:    commontypes.OracleID(i),
				}
			}
