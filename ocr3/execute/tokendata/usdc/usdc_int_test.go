...
func Test_USDC_CCTP_Flow(t *testing.T) {
	...
	tt := []struct {
		...
		want     exectypes2.TokenDataObservations
	}{
		{
			...
			want: exectypes2.TokenDataObservations{
				fujiChain: {
					1: exectypes2.MessageTokenData{
						TokenData: []exectypes2.TokenData{
							exectypes2.NewSuccessTokenData(m1.tokenData()),
						},
					},
				},
			},
			...
			want: exectypes2.TokenDataObservations{
				fujiChain: {
					1: exectypes2.MessageTokenData{
						TokenData: []exectypes2.TokenData{
							exectypes2.NewSuccessTokenData(m1.tokenData()),
							exectypes2.NewSuccessTokenData(m2.tokenData()),
						},
					},
					2: exectypes2.MessageTokenData{
						TokenData: []exectypes2.TokenData{
							exectypes2.NewSuccessTokenData(m3.tokenData()),
						},
					},
				},
			},
		},
		{
			...
			want: exectypes2.TokenDataObservations{
				sepoliaChain: {
					10: exectypes2.MessageTokenData{
						TokenData: []exectypes2.TokenData{
							exectypes2.NewSuccessTokenData(m4.tokenData()),
							exectypes2.NewSuccessTokenData(m5.tokenData()),
						},
					},
				},
			},
		},
		{
			...
			want: exectypes2.TokenDataObservations{
				...
				sepoliaChain: {
					...
					11: exectypes2.MessageTokenData{
						TokenData: []exectypes2.TokenData{
							exectypes2.NewSuccessTokenData(m5.tokenData()),
						},
					},
				...
				fujiChain: {
					1: exectypes2.MessageTokenData{
						TokenData: []exectypes2.TokenData{
							...
							exectypes2.NewErrorTokenData(tokendata.ErrDataMissing),
						},
					},
					2: exectypes2.MessageTokenData{
						TokenData: []exectypes2.TokenData{
		...
		},
		{
			...
			want: exectypes2.TokenDataObservations{
				sepoliaChain: {
					1: exectypes2.MessageTokenData{
						TokenData: []exectypes2.TokenData{
							exectypes2.NewErrorTokenData(errors.New("attestation API error: some error")),
						},
					},
					2: exectypes2.MessageTokenData{
						TokenData: []exectypes2.TokenData{
							exectypes2.NewErrorTokenData(fmt.Errorf("failed to decode attestation hex: %w",
								errors.New("Bytes must be of at least length 2 (i.e, '0x' prefix): 0"),
							)),
						},
					},
					3: exectypes2.MessageTokenData{
						TokenData: []exectypes2.TokenData{
							exectypes2.NewErrorTokenData(errors.New("invalid attestation response")),
						},
					},
					4: exectypes2.MessageTokenData{
						TokenData: []exectypes2.TokenData{
							exectypes2.NewErrorTokenData(errors.New("invalid attestation response")),
						},
					},
