...
func (p *PromReporter) TrackObservation(obs exectypes2.Observation, state exectypes2.PluginState) {
...
func (p *PromReporter) TrackOutcome(outcome exectypes2.Outcome, state exectypes2.PluginState) {
