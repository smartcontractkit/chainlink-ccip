...
import (
	...
	clrand "github.com/smartcontractkit/chainlink-ccip/ocr3/internal/libs/testhelpers/rand"
	"github.com/smartcontractkit/chainlink-ccip/ocr3/internal/mocks"
	"github.com/smartcontractkit/chainlink-ccip/ocr3/internal/plugintypes"
	readerinternal "github.com/smartcontractkit/chainlink-ccip/ocr3/internal/reader"
	ccipocr4 "github.com/smartcontractkit/chainlink-ccip/ocr3/mocks/chainlink_common/ccipocr3"
	mockinternalreader "github.com/smartcontractkit/chainlink-ccip/ocr3/mocks/internal_/reader"
	"github.com/smartcontractkit/chainlink-ccip/ocr3/mocks/pkg/reader"
...
type oracleMockDependencySet struct {
	ccipReader      *reader.MockCCIPReader
	priceReader     *reader.MockPriceReader
	reportCodec     *ccipocr4.MockCommitPluginCodec
	msgHasher       *mocks.MessageHasher
	lggr            logger.Logger
	homeChainReader *mockinternalreader.MockHomeChain
	rmnHomeReader   *reader.MockRMNHome
	addressCodec    *ccipocr4.MockAddressCodec
...
func newRoleDonTestSetup(t *testing.T, numSourceChains, numOracles, fChain int) roleDonTestSetup {
	...
	for i := range s.oracles {
		...
		s.oracleDependencies[s.oracles[i]] = oracleMockDependencySet{
			...
			priceReader:     reader.NewMockPriceReader(t),
			reportCodec:     ccipocr4.NewMockCommitPluginCodec(t),
			msgHasher:       mocks.NewMessageHasher(),
			lggr:            logger.Test(t),
			homeChainReader: mockinternalreader.NewMockHomeChain(t),
			rmnHomeReader:   reader.NewMockRMNHome(t),
			addressCodec:    ccipocr4.NewMockAddressCodec(t),
