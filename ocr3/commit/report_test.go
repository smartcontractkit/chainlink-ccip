...
import (
	...
	ccipocr3mock "github.com/smartcontractkit/chainlink-ccip/ocr3/mocks/chainlink_common/ccipocr3"
	"github.com/smartcontractkit/chainlink-ccip/ocr3/mocks/internal_/plugincommon"
	readermock "github.com/smartcontractkit/chainlink-ccip/ocr3/mocks/pkg/reader"
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			reader.EXPECT().GetOffRampSourceChainsConfig(ctx, mock.Anything).Return(
				map[ccipocr3.ChainSelector]reader.StaticSourceChainConfig{}, nil).Maybe()
