...
import (
	...
	chainfee2 "github.com/smartcontractkit/chainlink-ccip/ocr3/commit/chainfee"
	"github.com/smartcontractkit/chainlink-ccip/ocr3/commit/committypes"
	"github.com/smartcontractkit/chainlink-ccip/ocr3/commit/internal/builder"
	merkleroot2 "github.com/smartcontractkit/chainlink-ccip/ocr3/commit/merkleroot"
	rmn2 "github.com/smartcontractkit/chainlink-ccip/ocr3/commit/merkleroot/rmn"
	"github.com/smartcontractkit/chainlink-ccip/ocr3/commit/metrics"
	tokenprice2 "github.com/smartcontractkit/chainlink-ccip/ocr3/commit/tokenprice"
...
type attributedMerkleRootObservation = plugincommon2.AttributedObservation[merkleroot2.Observation]
type attributedTokenPricesObservation = plugincommon2.AttributedObservation[tokenprice2.Observation]
type attributedChainFeeObservation = plugincommon2.AttributedObservation[chainfee2.Observation]
...
type Plugin struct {
	...
	tokenPricesReader reader2.PriceReader
	...
	merkleRootProcessor plugincommon2.PluginProcessor[merkleroot2.Query, merkleroot2.Observation, merkleroot2.Outcome]
	tokenPriceProcessor plugincommon2.PluginProcessor[tokenprice2.Query, tokenprice2.Observation, tokenprice2.Outcome]
	chainFeeProcessor   plugincommon2.PluginProcessor[chainfee2.Query, chainfee2.Observation, chainfee2.Outcome]
	discoveryProcessor  plugincommon2.PluginProcessor[dt.Query, dt.Observation, dt.Outcome]
...
func NewPlugin(
	...
	rmnController := rmn2.NewController(
	...
	merkleRootProcessor := merkleroot2.NewProcessor(
		reportingCfg.OracleID,
		oracleIDToP2pID,
	...
	tokenPriceProcessor := tokenprice2.NewProcessor(
		reportingCfg.OracleID,
	...
	chainFeeProcessr := chainfee2.NewProcessor(
...
func (p *Plugin) Observation(
	...
	obs := committypes.Observation{
		...
		TokenPriceObs:         tokenprice2.Observation{},
		DiscoveryObs:          discoveryObs,
		ChainFeeObs:           chainfee2.Observation{},
...
) (tokenprice2.Observation, chainfee2.Observation) {
	var tokenPriceObs tokenprice2.Observation
	var chainFeeObs chainfee2.Observation
...
func (p *Plugin) Outcome(
	...
	discoveryObservations := make([]plugincommon2.AttributedObservation[dt.Observation], 0, len(aos))
	...
	for _, ao := range aos {
		...
		discoveryObservations = append(discoveryObservations, plugincommon2.AttributedObservation[dt.Observation]{
...
func (p *Plugin) getMainOutcomeAndCacheInvalidation(
	...
	donThresh := consensus2.MakeConstantThreshold[cciptypes.ChainSelector](consensus2.TwoFPlus1(p.reportingCfg.F))
	fChainConsensus := consensus2.GetConsensusMap(lggr, "mainFChain", fChainObservations, donThresh)
	...
	if consensus2.LtFPlusOne(fDestChain, len(observedOnChainOcrSeqNums)) {
