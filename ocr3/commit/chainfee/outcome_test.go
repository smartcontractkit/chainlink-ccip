...
func sameObs(n int, obs Observation) []plugincommon2.AttributedObservation[Observation] {
	aos := make([]plugincommon2.AttributedObservation[Observation], n)
	for i := 0; i < n; i++ {
		aos[i] = plugincommon2.AttributedObservation[Observation]{OracleID: commontypes.OracleID(i), Observation: obs}
	}
	return aos
}
...
func TestProcessor_Outcome(t *testing.T) {
	...
	cases := []struct {
		...
		aos                    []plugincommon2.AttributedObservation[Observation]
		expectedError          bool
		...
		{
			name:          "no consensus",
			aos:           []plugincommon2.AttributedObservation[Observation]{}, // Empty aos slice
		...
		},
		{
			...
			aos: func() []plugincommon2.AttributedObservation[Observation] {
				aos := make([]plugincommon2.AttributedObservation[Observation], numOracles)
				for i := 0; i < numOracles; i++ {
					aos[i] = plugincommon2.AttributedObservation[Observation]{
