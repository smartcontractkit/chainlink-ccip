...
import (
	...
	rmntypes "github.com/smartcontractkit/chainlink-ccip/ocr3/commit/merkleroot/rmn/types"
	...
	"github.com/smartcontractkit/chainlink-ccip/ocr3/mocks/commit/merkleroot"
	rmn_mock "github.com/smartcontractkit/chainlink-ccip/ocr3/mocks/commit/merkleroot/rmn"
	common_mock "github.com/smartcontractkit/chainlink-ccip/ocr3/mocks/internal_/plugincommon"
...
func TestObservation(t *testing.T) {
	...
	mockCCIPReader := reader.NewMockCCIPReader(t)
...
func Test_ObserveOffRampNextSeqNums(t *testing.T) {
	...
	testCases := []struct {
		...
		getDeps   func(t *testing.T) (*common_mock.MockChainSupport, *reader.MockCCIPReader)
	}{
		{
			name: "Happy path",
			getDeps: func(t *testing.T) (*common_mock.MockChainSupport, *reader.MockCCIPReader) {
