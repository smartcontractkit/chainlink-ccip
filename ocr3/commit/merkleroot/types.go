...
func aggregateObservations(aos []plugincommon2.AttributedObservation[Observation]) aggregatedObservation {
...
type MetricsReporter interface {
	...
	TrackProcessorOutput(processor string, method plugincommon2.MethodType, obs plugintypes.Trackable)
}
...
func (n NoopMetrics) TrackProcessorOutput(string, plugincommon2.MethodType, plugintypes.Trackable) {}
