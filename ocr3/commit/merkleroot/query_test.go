...
import (
	...
	rmnmocks "github.com/smartcontractkit/chainlink-ccip/ocr3/mocks/commit/merkleroot/rmn"
	reader2 "github.com/smartcontractkit/chainlink-ccip/ocr3/mocks/pkg/reader"
...
func TestProcessor_Query(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			ccipReader := reader2.NewMockCCIPReader(t)
			...
			rmnHomeReader := reader2.NewMockRMNHome(t)
