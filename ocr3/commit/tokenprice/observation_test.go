...
import (
	...
	readermock "github.com/smartcontractkit/chainlink-ccip/ocr3/mocks/internal_/reader"
...
func Test_Observation(t *testing.T) {
	...
	testCases := []struct {
		name         string
		getProcessor func(t *testing.T) plugincommon2.PluginProcessor[Query, Observation, Outcome]
		expObs       Observation
		expErr       error
	}{
		{
