...
import (
	...
	reader2 "github.com/smartcontractkit/chainlink-ccip/ocr3/mocks/internal_/reader"
	"github.com/smartcontractkit/chainlink-ccip/ocr3/mocks/pkg/reader"
	"github.com/smartcontractkit/chainlink-ccip/ocr3/pkg/ocrtypecodec/v1"
...
func TestObservation_prices(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			mrp := plugincommon2.NewMockPluginProcessor[merkleroot.Query, merkleroot.Observation, merkleroot.Outcome](t)
			tpp := plugincommon2.NewMockPluginProcessor[tokenprice.Query, tokenprice.Observation, tokenprice.Outcome](t)
			cfp := plugincommon2.NewMockPluginProcessor[chainfee.Query, chainfee.Observation, chainfee.Outcome](t)
