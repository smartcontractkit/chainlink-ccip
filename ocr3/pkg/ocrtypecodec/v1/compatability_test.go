...
var inputObjectOld = exectypes2.Outcome{
	State: "yee haw",
...
var inputObjectReports = exectypes2.Outcome{
	State: "yee haw",
	CommitReports: []exectypes2.CommitData{
		{
			SourceChain:         99,
...
func TestExistingEncodingCompatibility(t *testing.T) {
	...
	require.Equal(t, exectypes2.PluginState("yee haw"), outcome.State)
