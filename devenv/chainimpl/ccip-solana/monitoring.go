...
import (
	...
	"github.com/smartcontractkit/chainlink-ccip/ccv/chains/evm/gobindings/generated/v1_7_0/offramp"
	"github.com/smartcontractkit/chainlink-ccip/ccv/chains/evm/gobindings/generated/v1_7_0/onramp"
)
...
func ProcessLaneEvents(ctx context.Context, c *CCIP16Solana, lp *LokiPusher, cfg *LaneStreamConfig) error {
...
func FetchLaneEvents(ctx context.Context, c *CCIP16Solana, cfg *LaneStreamConfig) (*LaneStreams, error) {
