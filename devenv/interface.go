...
type OnChainConfigurable interface {
	...
	DeployContractsForSelector(ctx context.Context, env *deployment.Environment, cls []*nodeset.Input, selector uint64, ccipHomeSelector uint64) (datastore.DataStore, error)
