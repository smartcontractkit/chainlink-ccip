...
require (
	...
	github.com/smartcontractkit/chainlink-ccip/deployment v0.0.0-20260312130858-48d184a42678
)
...
require (
	...
	github.com/smartcontractkit/chainlink-ton v0.0.0-20260304145142-d4cf6759e50b // indirect
