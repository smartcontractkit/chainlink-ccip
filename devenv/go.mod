...
require (
	...
	github.com/smartcontractkit/chainlink-ccip v0.1.1-solana.0.20260316181046-db2c2566f1d1
	...
	github.com/smartcontractkit/chainlink-ccip/deployment v0.0.0-20260316181046-db2c2566f1d1
