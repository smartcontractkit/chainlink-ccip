...
require (
	...
	github.com/smartcontractkit/chainlink-ccip v0.1.1-solana.0.20260329160207-f6abb2a22bf9
	...
	github.com/smartcontractkit/chainlink-ccip/deployment v0.0.0-20260329160207-f6abb2a22bf9
