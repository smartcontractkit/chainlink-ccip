...
func (_m *MockConfigCacher) GetRMNRemoteAddress(ctx context.Context) ([]byte, error) {
	ret := _m.Called(ctx)
...
func (_c *MockConfigCacher_GetRMNRemoteAddress_Call) Return(_a0 []byte, _a1 error) *MockConfigCacher_GetRMNRemoteAddress_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockConfigCacher_GetRMNRemoteAddress_Call) RunAndReturn(run func(context.Context) ([]byte, error)) *MockConfigCacher_GetRMNRemoteAddress_Call {
	_c.Call.Return(run)
	return _c
}
