...
// GetOffRampSourceChainConfigs provides a mock function with given fields: ctx, sourceChainSelectors
func (_m *MockChainAccessor) GetOffRampSourceChainConfigs(ctx context.Context, sourceChainSelectors []ccipocr3.ChainSelector) (map[ccipocr3.ChainSelector]ccipocr3.SourceChainConfig, error) {
	ret := _m.Called(ctx, sourceChainSelectors)

	if len(ret) == 0 {
		panic("no return value specified for GetOffRampSourceChainConfigs")
	}
...
// MockChainAccessor_GetOffRampSourceChainConfigs_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetOffRampSourceChainConfigs'
type MockChainAccessor_GetOffRampSourceChainConfigs_Call struct {
	*mock.Call
}

// GetOffRampSourceChainConfigs is a helper method to define mock.On call
//   - ctx context.Context
//   - sourceChainSelectors []ccipocr3.ChainSelector
func (_e *MockChainAccessor_Expecter) GetOffRampSourceChainConfigs(ctx interface{}, sourceChainSelectors interface{}) *MockChainAccessor_GetOffRampSourceChainConfigs_Call {
	return &MockChainAccessor_GetOffRampSourceChainConfigs_Call{Call: _e.mock.On("GetOffRampSourceChainConfigs", ctx, sourceChainSelectors)}
}

func (_c *MockChainAccessor_GetOffRampSourceChainConfigs_Call) Run(run func(ctx context.Context, sourceChainSelectors []ccipocr3.ChainSelector)) *MockChainAccessor_GetOffRampSourceChainConfigs_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].([]ccipocr3.ChainSelector))
	})
	return _c
...
func (_c *MockChainAccessor_GetOffRampSourceChainConfigs_Call) Return(_a0 map[ccipocr3.ChainSelector]ccipocr3.SourceChainConfig, _a1 error) *MockChainAccessor_GetOffRampSourceChainConfigs_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockChainAccessor_GetOffRampSourceChainConfigs_Call) RunAndReturn(run func(context.Context, []ccipocr3.ChainSelector) (map[ccipocr3.ChainSelector]ccipocr3.SourceChainConfig, error)) *MockChainAccessor_GetOffRampSourceChainConfigs_Call {
	_c.Call.Return(run)
	return _c
}
