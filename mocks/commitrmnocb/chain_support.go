...
// SupportsChain provides a mock function with given fields: oracleID, selector
func (_m *MockChainSupport) SupportsChain(oracleID commontypes.OracleID, selector ccipocr3.ChainSelector) (bool, error) {
	ret := _m.Called(oracleID, selector)

	if len(ret) == 0 {
		panic("no return value specified for SupportsChain")
	}

	var r0 bool
	var r1 error
	if rf, ok := ret.Get(0).(func(commontypes.OracleID, ccipocr3.ChainSelector) (bool, error)); ok {
		return rf(oracleID, selector)
	}
	if rf, ok := ret.Get(0).(func(commontypes.OracleID, ccipocr3.ChainSelector) bool); ok {
		r0 = rf(oracleID, selector)
	} else {
		r0 = ret.Get(0).(bool)
	}

	if rf, ok := ret.Get(1).(func(commontypes.OracleID, ccipocr3.ChainSelector) error); ok {
		r1 = rf(oracleID, selector)
	} else {
		r1 = ret.Error(1)
	}
...
// MockChainSupport_SupportsChain_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'SupportsChain'
type MockChainSupport_SupportsChain_Call struct {
	*mock.Call
}

// SupportsChain is a helper method to define mock.On call
//   - oracleID commontypes.OracleID
//   - selector ccipocr3.ChainSelector
func (_e *MockChainSupport_Expecter) SupportsChain(oracleID interface{}, selector interface{}) *MockChainSupport_SupportsChain_Call {
	return &MockChainSupport_SupportsChain_Call{Call: _e.mock.On("SupportsChain", oracleID, selector)}
}

func (_c *MockChainSupport_SupportsChain_Call) Run(run func(oracleID commontypes.OracleID, selector ccipocr3.ChainSelector)) *MockChainSupport_SupportsChain_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(commontypes.OracleID), args[1].(ccipocr3.ChainSelector))
	})
	return _c
}

func (_c *MockChainSupport_SupportsChain_Call) Return(_a0 bool, _a1 error) *MockChainSupport_SupportsChain_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockChainSupport_SupportsChain_Call) RunAndReturn(run func(commontypes.OracleID, ccipocr3.ChainSelector) (bool, error)) *MockChainSupport_SupportsChain_Call {
	_c.Call.Return(run)
	return _c
}
