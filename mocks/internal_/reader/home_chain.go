...
func (_m *MockHomeChain) GetRMNNodesInfo(configDigest ccipocr3.Bytes32) ([]types.RMNHomeNodeInfo, error) {
	ret := _m.Called(configDigest)
...
func (_c *MockHomeChain_GetRMNNodesInfo_Call) Return(_a0 []types.RMNHomeNodeInfo, _a1 error) *MockHomeChain_GetRMNNodesInfo_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockHomeChain_GetRMNNodesInfo_Call) RunAndReturn(run func(ccipocr3.Bytes32) ([]types.RMNHomeNodeInfo, error)) *MockHomeChain_GetRMNNodesInfo_Call {
	_c.Call.Return(run)
	return _c
}

// GetSupportedChainsForPeer provides a mock function with given fields: id
func (_m *MockHomeChain) GetSupportedChainsForPeer(id ragep2ptypes.PeerID) (mapset.Set[ccipocr3.ChainSelector], error) {
	ret := _m.Called(id)
	...
	var r0 mapset.Set[ccipocr3.ChainSelector]
	var r1 error
	if rf, ok := ret.Get(0).(func(ragep2ptypes.PeerID) (mapset.Set[ccipocr3.ChainSelector], error)); ok {
		return rf(id)
	}
	if rf, ok := ret.Get(0).(func(ragep2ptypes.PeerID) mapset.Set[ccipocr3.ChainSelector]); ok {
		r0 = rf(id)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(mapset.Set[ccipocr3.ChainSelector])
	...
	if rf, ok := ret.Get(1).(func(ragep2ptypes.PeerID) error); ok {
		r1 = rf(id)
	} else {
		r1 = ret.Error(1)
	}
...
func (_c *MockHomeChain_GetSupportedChainsForPeer_Call) Run(run func(id ragep2ptypes.PeerID)) *MockHomeChain_GetSupportedChainsForPeer_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(ragep2ptypes.PeerID))
	})
	return _c
}
...
func (_c *MockHomeChain_GetSupportedChainsForPeer_Call) RunAndReturn(run func(ragep2ptypes.PeerID) (mapset.Set[ccipocr3.ChainSelector], error)) *MockHomeChain_GetSupportedChainsForPeer_Call {
	_c.Call.Return(run)
	return _c
}
