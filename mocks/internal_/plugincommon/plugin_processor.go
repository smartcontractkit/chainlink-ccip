...
func (_m *MockPluginProcessor[QueryType, ObservationType, OutcomeType]) Outcome(prevOutcome OutcomeType, query QueryType, aos []plugincommon.AttributedObservation[ObservationType]) (OutcomeType, error) {
	...
	var r0 OutcomeType
	var r1 error
	if rf, ok := ret.Get(0).(func(OutcomeType, QueryType, []plugincommon.AttributedObservation[ObservationType]) (OutcomeType, error)); ok {
		return rf(prevOutcome, query, aos)
	}
	if rf, ok := ret.Get(0).(func(OutcomeType, QueryType, []plugincommon.AttributedObservation[ObservationType]) OutcomeType); ok {
		r0 = rf(prevOutcome, query, aos)
	} else {
		r0 = ret.Get(0).(OutcomeType)
	}

	if rf, ok := ret.Get(1).(func(OutcomeType, QueryType, []plugincommon.AttributedObservation[ObservationType]) error); ok {
...
//   - prevOutcome OutcomeType
//   - query QueryType
//   - aos []plugincommon.AttributedObservation[ObservationType]
...
func (_c *MockPluginProcessor_Outcome_Call[QueryType, ObservationType, OutcomeType]) Run(run func(prevOutcome OutcomeType, query QueryType, aos []plugincommon.AttributedObservation[ObservationType])) *MockPluginProcessor_Outcome_Call[QueryType, ObservationType, OutcomeType] {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(OutcomeType), args[1].(QueryType), args[2].([]plugincommon.AttributedObservation[ObservationType]))
	})
	return _c
}
...
func (_c *MockPluginProcessor_Outcome_Call[QueryType, ObservationType, OutcomeType]) RunAndReturn(run func(OutcomeType, QueryType, []plugincommon.AttributedObservation[ObservationType]) (OutcomeType, error)) *MockPluginProcessor_Outcome_Call[QueryType, ObservationType, OutcomeType] {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockPluginProcessor[QueryType, ObservationType, OutcomeType]) ValidateObservation(prevOutcome OutcomeType, query QueryType, ao plugincommon.AttributedObservation[ObservationType]) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(OutcomeType, QueryType, plugincommon.AttributedObservation[ObservationType]) error); ok {
...
//   - prevOutcome OutcomeType
//   - query QueryType
//   - ao plugincommon.AttributedObservation[ObservationType]
...
func (_c *MockPluginProcessor_ValidateObservation_Call[QueryType, ObservationType, OutcomeType]) Run(run func(prevOutcome OutcomeType, query QueryType, ao plugincommon.AttributedObservation[ObservationType])) *MockPluginProcessor_ValidateObservation_Call[QueryType, ObservationType, OutcomeType] {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(OutcomeType), args[1].(QueryType), args[2].(plugincommon.AttributedObservation[ObservationType]))
	})
	return _c
...
func (_c *MockPluginProcessor_ValidateObservation_Call[QueryType, ObservationType, OutcomeType]) RunAndReturn(run func(OutcomeType, QueryType, plugincommon.AttributedObservation[ObservationType]) error) *MockPluginProcessor_ValidateObservation_Call[QueryType, ObservationType, OutcomeType] {
	_c.Call.Return(run)
	return _c
}
