...
// ObserveTokenPrices provides a mock function with given fields: ctx
func (_m *MockObserver) ObserveTokenPrices(ctx context.Context) []ccipocr3.TokenPrice {
	ret := _m.Called(ctx)

	if len(ret) == 0 {
		panic("no return value specified for ObserveTokenPrices")
	}
...
// MockObserver_ObserveTokenPrices_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'ObserveTokenPrices'
type MockObserver_ObserveTokenPrices_Call struct {
	*mock.Call
}

// ObserveTokenPrices is a helper method to define mock.On call
//   - ctx context.Context
func (_e *MockObserver_Expecter) ObserveTokenPrices(ctx interface{}) *MockObserver_ObserveTokenPrices_Call {
	return &MockObserver_ObserveTokenPrices_Call{Call: _e.mock.On("ObserveTokenPrices", ctx)}
}

func (_c *MockObserver_ObserveTokenPrices_Call) Run(run func(ctx context.Context)) *MockObserver_ObserveTokenPrices_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context))
	})
	return _c
...
func (_c *MockObserver_ObserveTokenPrices_Call) Return(_a0 []ccipocr3.TokenPrice) *MockObserver_ObserveTokenPrices_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockObserver_ObserveTokenPrices_Call) RunAndReturn(run func(context.Context) []ccipocr3.TokenPrice) *MockObserver_ObserveTokenPrices_Call {
	_c.Call.Return(run)
	return _c
}
