...
func (_m *MockController) ComputeReportSignatures(ctx context.Context, destChain *rmnpb.LaneDest, requestedUpdates []*rmnpb.FixedDestLaneUpdateRequest) (*rmn.ReportSignatures, error) {
...
func (_e *MockController_Expecter) ComputeReportSignatures(ctx interface{}, destChain interface{}, requestedUpdates interface{}) *MockController_ComputeReportSignatures_Call {
	return &MockController_ComputeReportSignatures_Call{Call: _e.mock.On("ComputeReportSignatures", ctx, destChain, requestedUpdates)}
}

func (_c *MockController_ComputeReportSignatures_Call) Run(run func(ctx context.Context, destChain *rmnpb.LaneDest, requestedUpdates []*rmnpb.FixedDestLaneUpdateRequest)) *MockController_ComputeReportSignatures_Call {
...
func (_c *MockController_ComputeReportSignatures_Call) RunAndReturn(run func(context.Context, *rmnpb.LaneDest, []*rmnpb.FixedDestLaneUpdateRequest) (*rmn.ReportSignatures, error)) *MockController_ComputeReportSignatures_Call {
	_c.Call.Return(run)
	return _c
}
