module github.com/smartcontractkit/crib/cli
...
require (
	...
	github.com/smartcontractkit/chainlink-testing-framework/wasp v1.50.5
	github.com/smartcontractkit/chainlink/dashboard-lib v0.0.0-20250127075144-cd4c9b1a2556
