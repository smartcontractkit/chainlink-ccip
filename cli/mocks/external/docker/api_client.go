...
func (_c *APIClient_BuildCachePrune_Call) Run(run func(ctx context.Context, opts types.BuildCachePruneOptions)) *APIClient_BuildCachePrune_Call {
...
func (_c *APIClient_BuildCachePrune_Call) Return(_a0 *types.BuildCachePruneReport, _a1 error) *APIClient_BuildCachePrune_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *APIClient_BuildCachePrune_Call) RunAndReturn(run func(context.Context, types.BuildCachePruneOptions) (*types.BuildCachePruneReport, error)) *APIClient_BuildCachePrune_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *APIClient_ConfigCreate_Call) Return(_a0 types.ConfigCreateResponse, _a1 error) *APIClient_ConfigCreate_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *APIClient_ConfigCreate_Call) RunAndReturn(run func(context.Context, swarm.ConfigSpec) (types.ConfigCreateResponse, error)) *APIClient_ConfigCreate_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *APIClient_ConfigList_Call) Run(run func(ctx context.Context, options types.ConfigListOptions)) *APIClient_ConfigList_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *APIClient_ConfigList_Call) RunAndReturn(run func(context.Context, types.ConfigListOptions) ([]swarm.Config, error)) *APIClient_ConfigList_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *APIClient) ContainerCommit(ctx context.Context, _a1 string, options container.CommitOptions) (types.IDResponse, error) {
	ret := _m.Called(ctx, _a1, options)
...
func (_c *APIClient_ContainerCommit_Call) Return(_a0 types.IDResponse, _a1 error) *APIClient_ContainerCommit_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *APIClient_ContainerCommit_Call) RunAndReturn(run func(context.Context, string, container.CommitOptions) (types.IDResponse, error)) *APIClient_ContainerCommit_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *APIClient_ContainerExecAttach_Call) Run(run func(ctx context.Context, execID string, options container.ExecStartOptions)) *APIClient_ContainerExecAttach_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *APIClient_ContainerExecAttach_Call) RunAndReturn(run func(context.Context, string, container.ExecStartOptions) (types.HijackedResponse, error)) *APIClient_ContainerExecAttach_Call {
	_c.Call.Return(run)
	return _c
}

// ContainerExecCreate provides a mock function with given fields: ctx, _a1, options
func (_m *APIClient) ContainerExecCreate(ctx context.Context, _a1 string, options container.ExecOptions) (types.IDResponse, error) {
	ret := _m.Called(ctx, _a1, options)
...
func (_c *APIClient_ContainerExecCreate_Call) Return(_a0 types.IDResponse, _a1 error) *APIClient_ContainerExecCreate_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *APIClient_ContainerExecCreate_Call) RunAndReturn(run func(context.Context, string, container.ExecOptions) (types.IDResponse, error)) *APIClient_ContainerExecCreate_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *APIClient_ContainerInspect_Call) Return(_a0 types.ContainerJSON, _a1 error) *APIClient_ContainerInspect_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *APIClient_ContainerInspect_Call) RunAndReturn(run func(context.Context, string) (types.ContainerJSON, error)) *APIClient_ContainerInspect_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *APIClient_ContainerInspectWithRaw_Call) Return(_a0 types.ContainerJSON, _a1 []byte, _a2 error) *APIClient_ContainerInspectWithRaw_Call {
	_c.Call.Return(_a0, _a1, _a2)
	return _c
}

func (_c *APIClient_ContainerInspectWithRaw_Call) RunAndReturn(run func(context.Context, string, bool) (types.ContainerJSON, []byte, error)) *APIClient_ContainerInspectWithRaw_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *APIClient_ContainerList_Call) Return(_a0 []types.Container, _a1 error) *APIClient_ContainerList_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *APIClient_ContainerList_Call) RunAndReturn(run func(context.Context, container.ListOptions) ([]types.Container, error)) *APIClient_ContainerList_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *APIClient_ContainerTop_Call) Return(_a0 container.ContainerTopOKBody, _a1 error) *APIClient_ContainerTop_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *APIClient_ContainerTop_Call) RunAndReturn(run func(context.Context, string, []string) (container.ContainerTopOKBody, error)) *APIClient_ContainerTop_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *APIClient_ContainerUpdate_Call) Return(_a0 container.ContainerUpdateOKBody, _a1 error) *APIClient_ContainerUpdate_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *APIClient_ContainerUpdate_Call) RunAndReturn(run func(context.Context, string, container.UpdateConfig) (container.ContainerUpdateOKBody, error)) *APIClient_ContainerUpdate_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *APIClient_ImageBuild_Call) Run(run func(ctx context.Context, _a1 io.Reader, options types.ImageBuildOptions)) *APIClient_ImageBuild_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *APIClient_ImageBuild_Call) Return(_a0 types.ImageBuildResponse, _a1 error) *APIClient_ImageBuild_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *APIClient_ImageBuild_Call) RunAndReturn(run func(context.Context, io.Reader, types.ImageBuildOptions) (types.ImageBuildResponse, error)) *APIClient_ImageBuild_Call {
	_c.Call.Return(run)
	return _c
}
...
//   - ctx context.Context
//   - _a1 string
func (_e *APIClient_Expecter) ImageHistory(ctx interface{}, _a1 interface{}) *APIClient_ImageHistory_Call {
	return &APIClient_ImageHistory_Call{Call: _e.mock.On("ImageHistory", ctx, _a1)}
}

func (_c *APIClient_ImageHistory_Call) Run(run func(ctx context.Context, _a1 string)) *APIClient_ImageHistory_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string))
	})
	return _c
...
func (_c *APIClient_ImageHistory_Call) RunAndReturn(run func(context.Context, string) ([]image.HistoryResponseItem, error)) *APIClient_ImageHistory_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *APIClient_ImageInspectWithRaw_Call) Return(_a0 types.ImageInspect, _a1 []byte, _a2 error) *APIClient_ImageInspectWithRaw_Call {
	_c.Call.Return(_a0, _a1, _a2)
	return _c
}

func (_c *APIClient_ImageInspectWithRaw_Call) RunAndReturn(run func(context.Context, string) (types.ImageInspect, []byte, error)) *APIClient_ImageInspectWithRaw_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *APIClient) ImageLoad(ctx context.Context, input io.Reader, quiet bool) (image.LoadResponse, error) {
...
//   - input io.Reader
//   - quiet bool
func (_e *APIClient_Expecter) ImageLoad(ctx interface{}, input interface{}, quiet interface{}) *APIClient_ImageLoad_Call {
	return &APIClient_ImageLoad_Call{Call: _e.mock.On("ImageLoad", ctx, input, quiet)}
}

func (_c *APIClient_ImageLoad_Call) Run(run func(ctx context.Context, input io.Reader, quiet bool)) *APIClient_ImageLoad_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *APIClient_ImageLoad_Call) RunAndReturn(run func(context.Context, io.Reader, bool) (image.LoadResponse, error)) *APIClient_ImageLoad_Call {
	_c.Call.Return(run)
	return _c
}
...
//   - ctx context.Context
//   - images []string
func (_e *APIClient_Expecter) ImageSave(ctx interface{}, images interface{}) *APIClient_ImageSave_Call {
	return &APIClient_ImageSave_Call{Call: _e.mock.On("ImageSave", ctx, images)}
}
...
func (_c *APIClient_ImageSave_Call) RunAndReturn(run func(context.Context, []string) (io.ReadCloser, error)) *APIClient_ImageSave_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *APIClient_NetworkList_Call) Return(_a0 []network.Inspect, _a1 error) *APIClient_NetworkList_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *APIClient_NetworkList_Call) RunAndReturn(run func(context.Context, network.ListOptions) ([]network.Inspect, error)) *APIClient_NetworkList_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *APIClient_NodeList_Call) Run(run func(ctx context.Context, options types.NodeListOptions)) *APIClient_NodeList_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *APIClient_NodeList_Call) RunAndReturn(run func(context.Context, types.NodeListOptions) ([]swarm.Node, error)) *APIClient_NodeList_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *APIClient_NodeRemove_Call) Run(run func(ctx context.Context, nodeID string, options types.NodeRemoveOptions)) *APIClient_NodeRemove_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *APIClient_NodeRemove_Call) RunAndReturn(run func(context.Context, string, types.NodeRemoveOptions) error) *APIClient_NodeRemove_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *APIClient_SecretCreate_Call) Return(_a0 types.SecretCreateResponse, _a1 error) *APIClient_SecretCreate_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *APIClient_SecretCreate_Call) RunAndReturn(run func(context.Context, swarm.SecretSpec) (types.SecretCreateResponse, error)) *APIClient_SecretCreate_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *APIClient_SecretList_Call) Run(run func(ctx context.Context, options types.SecretListOptions)) *APIClient_SecretList_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *APIClient_SecretList_Call) RunAndReturn(run func(context.Context, types.SecretListOptions) ([]swarm.Secret, error)) *APIClient_SecretList_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *APIClient) ServiceCreate(ctx context.Context, service swarm.ServiceSpec, options types.ServiceCreateOptions) (swarm.ServiceCreateResponse, error) {
...
func (_c *APIClient_ServiceCreate_Call) Run(run func(ctx context.Context, service swarm.ServiceSpec, options types.ServiceCreateOptions)) *APIClient_ServiceCreate_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *APIClient_ServiceCreate_Call) RunAndReturn(run func(context.Context, swarm.ServiceSpec, types.ServiceCreateOptions) (swarm.ServiceCreateResponse, error)) *APIClient_ServiceCreate_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *APIClient_ServiceInspectWithRaw_Call) Run(run func(ctx context.Context, serviceID string, options types.ServiceInspectOptions)) *APIClient_ServiceInspectWithRaw_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *APIClient_ServiceInspectWithRaw_Call) RunAndReturn(run func(context.Context, string, types.ServiceInspectOptions) (swarm.Service, []byte, error)) *APIClient_ServiceInspectWithRaw_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *APIClient_ServiceList_Call) Run(run func(ctx context.Context, options types.ServiceListOptions)) *APIClient_ServiceList_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *APIClient_ServiceList_Call) RunAndReturn(run func(context.Context, types.ServiceListOptions) ([]swarm.Service, error)) *APIClient_ServiceList_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *APIClient) ServiceUpdate(ctx context.Context, serviceID string, version swarm.Version, service swarm.ServiceSpec, options types.ServiceUpdateOptions) (swarm.ServiceUpdateResponse, error) {
...
func (_c *APIClient_ServiceUpdate_Call) Run(run func(ctx context.Context, serviceID string, version swarm.Version, service swarm.ServiceSpec, options types.ServiceUpdateOptions)) *APIClient_ServiceUpdate_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *APIClient_ServiceUpdate_Call) RunAndReturn(run func(context.Context, string, swarm.Version, swarm.ServiceSpec, types.ServiceUpdateOptions) (swarm.ServiceUpdateResponse, error)) *APIClient_ServiceUpdate_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *APIClient_SwarmGetUnlockKey_Call) Return(_a0 types.SwarmUnlockKeyResponse, _a1 error) *APIClient_SwarmGetUnlockKey_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *APIClient_SwarmGetUnlockKey_Call) RunAndReturn(run func(context.Context) (types.SwarmUnlockKeyResponse, error)) *APIClient_SwarmGetUnlockKey_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *APIClient_TaskList_Call) Run(run func(ctx context.Context, options types.TaskListOptions)) *APIClient_TaskList_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *APIClient_TaskList_Call) RunAndReturn(run func(context.Context, types.TaskListOptions) ([]swarm.Task, error)) *APIClient_TaskList_Call {
	_c.Call.Return(run)
	return _c
}
