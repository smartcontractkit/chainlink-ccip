...
require (
	...
	github.com/smartcontractkit/chainlink-ccip/deployment v0.0.0-20260320173405-6792325c5a25
...
require github.com/smartcontractkit/chainlink-protos/node-platform v0.0.0-20260205130626-db2a2aab956b // indirect
