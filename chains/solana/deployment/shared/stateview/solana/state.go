...
import (
	...
	signer_registry "github.com/smartcontractkit/chainlink-ccip/chains/solana/deployment/shared/bindings/signer_registry_solana"
	...
	solanaview "github.com/smartcontractkit/chainlink-ccip/chains/solana/deployment/view/solana"
)
...
func (s CCIPChainState) GenerateView(e *cldf.Environment, selector uint64) (solanaview.SolChainView, error) {
	chainView := solanaview.NewSolChain()
