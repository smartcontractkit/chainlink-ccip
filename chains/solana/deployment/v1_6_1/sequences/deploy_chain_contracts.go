...
import (
	...
	fqops "github.com/smartcontractkit/chainlink-ccip/chains/solana/deployment/v1_6_1/operations/fee_quoter"
	offrampops "github.com/smartcontractkit/chainlink-ccip/chains/solana/deployment/v1_6_1/operations/offramp"
	...
	testreceiverops "github.com/smartcontractkit/chainlink-ccip/chains/solana/deployment/v1_6_1/operations/test_receiver"
...
var DeployChainContracts = cldf_ops.NewSequence(
	...
	func(b operations.Bundle, chains cldf_chain.BlockChains, input deployops.ContractDeploymentConfigPerChainWithAddress) (output sequences.OnChainOutput, err error) {
		...
		burnMintTokenPoolRef, err := operations.ExecuteOperation(b, tokenpoolops.DeployBurnMint, chain, input.ExistingAddresses)
		if err != nil {
		...
		lockReleaseTokenPoolRef, err := operations.ExecuteOperation(b, tokenpoolops.DeployLockRelease, chain, input.ExistingAddresses)
		if err != nil {
