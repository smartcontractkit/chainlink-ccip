...
func TestSaveExistingCCIP(t *testing.T) {
	...
	cfg := commonchangeset.ExistingContractsConfig{
		ExistingContracts: []commonchangeset.Contract{
			{
				Address:        solAddr1,
				TypeAndVersion: cldf.NewTypeAndVersion(shared.Router, shared.Version1_0_0),
				ChainSelector:  selector,
			},
			{
				Address:        solAddr2,
				TypeAndVersion: cldf.NewTypeAndVersion(commontypes.LinkToken, shared.Version1_0_0),
				ChainSelector:  selector,
			},
		},
	}
