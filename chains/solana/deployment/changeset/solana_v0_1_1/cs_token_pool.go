...
func recordTokenMultisig(
	...
	legacyTV := cldf.NewTypeAndVersion("TokenMultisig", shared.Version1_0_0)
	...
	datastoreTV := cldf.NewTypeAndVersion("TOKEN_MULTISIG", shared.Version1_6_0)
...
func AddTokenPoolLookupTable(e cldf.Environment, cfg TokenPoolLookupTableConfig) (cldf.ChangesetOutput, error) {
	...
	typeVersion := cldf.NewTypeAndVersion(shared.TokenPoolLookupTable, shared.Version1_0_0)
	...
	ds := datastore.NewMemoryDataStore()
	tv := cldf.NewTypeAndVersion(shared.TokenPoolLookupTable, shared.Version1_0_0)
