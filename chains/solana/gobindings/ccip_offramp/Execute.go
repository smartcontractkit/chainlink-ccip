...
func (inst *Execute) SetRmnRemoteConfigAndCursesAccount(rmnRemoteConfigAndCurses ag_solanago.PublicKey) *Execute {
...
func (inst *Execute) GetRmnRemoteConfigAndCursesAccount() *ag_solanago.AccountMeta {
...
func NewExecuteInstruction(
	...
	rmnRemoteConfigAndCurses ag_solanago.PublicKey) *Execute {
