...
// NewUpdateSourceChainConfigInstructionBuilder creates a new `UpdateSourceChainConfigInstruction` instruction builder.
func NewUpdateSourceChainConfigInstructionBuilder() *UpdateSourceChainConfigInstruction {
	nd := &UpdateSourceChainConfigInstruction{
...
func (inst *UpdateSourceChainConfigInstruction) SetSourceChainSelector(source_chain_selector uint64) *UpdateSourceChainConfigInstruction {
	inst.SourceChainSelector = &source_chain_selector
	return inst
}

// SetSourceChainConfig sets the "source_chain_config" parameter.
func (inst *UpdateSourceChainConfigInstruction) SetSourceChainConfig(source_chain_config SourceChainConfig) *UpdateSourceChainConfigInstruction {
	inst.SourceChainConfig = &source_chain_config
	return inst
}

// SetSourceChainAccount sets the "source_chain" account.
func (inst *UpdateSourceChainConfigInstruction) SetSourceChainAccount(sourceChain ag_solanago.PublicKey) *UpdateSourceChainConfigInstruction {
	inst.AccountMetaSlice[0] = ag_solanago.Meta(sourceChain).WRITE()
	return inst
}

// GetSourceChainAccount gets the "source_chain" account.
func (inst *UpdateSourceChainConfigInstruction) GetSourceChainAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(0)
}

// SetConfigAccount sets the "config" account.
func (inst *UpdateSourceChainConfigInstruction) SetConfigAccount(config ag_solanago.PublicKey) *UpdateSourceChainConfigInstruction {
	inst.AccountMetaSlice[1] = ag_solanago.Meta(config)
	return inst
}

// GetConfigAccount gets the "config" account.
func (inst *UpdateSourceChainConfigInstruction) GetConfigAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(1)
}

// SetAuthorityAccount sets the "authority" account.
func (inst *UpdateSourceChainConfigInstruction) SetAuthorityAccount(authority ag_solanago.PublicKey) *UpdateSourceChainConfigInstruction {
	inst.AccountMetaSlice[2] = ag_solanago.Meta(authority).WRITE().SIGNER()
	return inst
}

// GetAuthorityAccount gets the "authority" account.
func (inst *UpdateSourceChainConfigInstruction) GetAuthorityAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(2)
}

func (inst UpdateSourceChainConfigInstruction) Build() *Instruction {
...
func (inst UpdateSourceChainConfigInstruction) ValidateAndBuild() (*Instruction, error) {
...
func (inst *UpdateSourceChainConfigInstruction) Validate() error {
...
func (inst *UpdateSourceChainConfigInstruction) EncodeToTree(parent ag_treeout.Branches) {
...
func (obj UpdateSourceChainConfigInstruction) MarshalWithEncoder(encoder *ag_binary.Encoder) (err error) {
...
func (obj *UpdateSourceChainConfigInstruction) UnmarshalWithDecoder(decoder *ag_binary.Decoder) (err error) {
...
func NewUpdateSourceChainConfigInstruction(
	...
	authority ag_solanago.PublicKey) *UpdateSourceChainConfigInstruction {
