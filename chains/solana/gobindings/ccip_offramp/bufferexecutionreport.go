...
// NewBufferExecutionReportInstructionBuilder creates a new `BufferExecutionReportInstruction` instruction builder.
func NewBufferExecutionReportInstructionBuilder() *BufferExecutionReportInstruction {
	nd := &BufferExecutionReportInstruction{
		AccountMetaSlice: make(ag_solanago.AccountMetaSlice, 4),
	}
	return nd
}

// SetBufferId sets the "buffer_id" parameter.
func (inst *BufferExecutionReportInstruction) SetBufferId(buffer_id []byte) *BufferExecutionReportInstruction {
	inst.BufferId = &buffer_id
	return inst
}

// SetReportLength sets the "report_length" parameter.
func (inst *BufferExecutionReportInstruction) SetReportLength(report_length uint32) *BufferExecutionReportInstruction {
	inst.ReportLength = &report_length
	return inst
}

// SetChunk sets the "chunk" parameter.
func (inst *BufferExecutionReportInstruction) SetChunk(chunk []byte) *BufferExecutionReportInstruction {
	inst.Chunk = &chunk
	return inst
}

// SetChunkIndex sets the "chunk_index" parameter.
func (inst *BufferExecutionReportInstruction) SetChunkIndex(chunk_index uint8) *BufferExecutionReportInstruction {
	inst.ChunkIndex = &chunk_index
	return inst
}

// SetNumChunks sets the "num_chunks" parameter.
func (inst *BufferExecutionReportInstruction) SetNumChunks(num_chunks uint8) *BufferExecutionReportInstruction {
	inst.NumChunks = &num_chunks
	return inst
}

// SetExecutionReportBufferAccount sets the "execution_report_buffer" account.
func (inst *BufferExecutionReportInstruction) SetExecutionReportBufferAccount(executionReportBuffer ag_solanago.PublicKey) *BufferExecutionReportInstruction {
...
func (inst *BufferExecutionReportInstruction) GetExecutionReportBufferAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(0)
}

// SetConfigAccount sets the "config" account.
func (inst *BufferExecutionReportInstruction) SetConfigAccount(config ag_solanago.PublicKey) *BufferExecutionReportInstruction {
	inst.AccountMetaSlice[1] = ag_solanago.Meta(config)
	return inst
}

// GetConfigAccount gets the "config" account.
func (inst *BufferExecutionReportInstruction) GetConfigAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(1)
}

// SetAuthorityAccount sets the "authority" account.
func (inst *BufferExecutionReportInstruction) SetAuthorityAccount(authority ag_solanago.PublicKey) *BufferExecutionReportInstruction {
	inst.AccountMetaSlice[2] = ag_solanago.Meta(authority).WRITE().SIGNER()
	return inst
}

// GetAuthorityAccount gets the "authority" account.
func (inst *BufferExecutionReportInstruction) GetAuthorityAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(2)
}

// SetSystemProgramAccount sets the "system_program" account.
func (inst *BufferExecutionReportInstruction) SetSystemProgramAccount(systemProgram ag_solanago.PublicKey) *BufferExecutionReportInstruction {
	inst.AccountMetaSlice[3] = ag_solanago.Meta(systemProgram)
	return inst
}

// GetSystemProgramAccount gets the "system_program" account.
func (inst *BufferExecutionReportInstruction) GetSystemProgramAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(3)
}

func (inst BufferExecutionReportInstruction) Build() *Instruction {
...
func (inst BufferExecutionReportInstruction) ValidateAndBuild() (*Instruction, error) {
...
func (inst *BufferExecutionReportInstruction) Validate() error {
...
func (inst *BufferExecutionReportInstruction) EncodeToTree(parent ag_treeout.Branches) {
...
func (obj BufferExecutionReportInstruction) MarshalWithEncoder(encoder *ag_binary.Encoder) (err error) {
...
func (obj *BufferExecutionReportInstruction) UnmarshalWithDecoder(decoder *ag_binary.Decoder) (err error) {
...
func NewBufferExecutionReportInstruction(
	...
	systemProgram ag_solanago.PublicKey) *BufferExecutionReportInstruction {
	return NewBufferExecutionReportInstructionBuilder().
		SetBufferId(buffer_id).
		SetReportLength(report_length).
		SetChunk(chunk).
		SetChunkIndex(chunk_index).
		SetNumChunks(num_chunks).
