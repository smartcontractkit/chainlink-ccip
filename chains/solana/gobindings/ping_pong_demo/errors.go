...
var (
	...
	ErrInvalidMessageDataLength = &customErrorDef{
		code: 6001,
		msg:  "Invalid message data length",
		name: "InvalidMessageDataLength",
	}
	ErrInvalidCounterpartAddress = &customErrorDef{
		code: 6002,
		msg:  "Invalid counterpart address",
		name: "InvalidCounterpartAddress",
	}
	Errors = map[int]CustomError{
		6000: ErrUnauthorized,
		6001: ErrInvalidMessageDataLength,
		6002: ErrInvalidCounterpartAddress,
	}
)
