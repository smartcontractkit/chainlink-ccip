...
type StartPingPong struct {
	...
	// ··········· CHECK
	//
	// [9] = [WRITE] ccipRouterDestChainState
	// ··········· CHECK
	//
	// [10] = [WRITE] ccipRouterNonce
	// ··········· CHECK
	//
	// [11] = [WRITE] ccipRouterFeeReceiver
	// ··········· CHECK
	//
	// [12] = [] ccipRouterFeeBillingSigner
	// ··········· CHECK
	//
	// [13] = [] feeQuoter
	// ··········· CHECK
	...
	// ··········· CHECK
	//
	// [15] = [] feeQuoterDestChain
	// ··········· CHECK
	//
	// [16] = [] feeQuoterBillingTokenConfig
	// ··········· CHECK
	//
	// [17] = [] feeQuoterLinkTokenConfig
	// ··········· CHECK
	//
	// [18] = [] rmnRemote
	// ··········· CHECK
...
func (inst *StartPingPong) SetCounterpartChainSelector(counterpartChainSelector uint64) *StartPingPong {
	inst.CounterpartChainSelector = &counterpartChainSelector
	return inst
}

// SetGlobalConfigAccount sets the "globalConfig" account.
func (inst *StartPingPong) SetGlobalConfigAccount(globalConfig ag_solanago.PublicKey) *StartPingPong {
	inst.AccountMetaSlice[0] = ag_solanago.Meta(globalConfig)
	return inst
}

// GetGlobalConfigAccount gets the "globalConfig" account.
func (inst *StartPingPong) GetGlobalConfigAccount() *ag_solanago.AccountMeta {
...
func (inst *StartPingPong) SetCcipSendSignerAccount(ccipSendSigner ag_solanago.PublicKey) *StartPingPong {
	inst.AccountMetaSlice[3] = ag_solanago.Meta(ccipSendSigner).WRITE()
	return inst
}
...
func (inst *StartPingPong) SetFeeTokenProgramAccount(feeTokenProgram ag_solanago.PublicKey) *StartPingPong {
	inst.AccountMetaSlice[4] = ag_solanago.Meta(feeTokenProgram)
	return inst
}
...
func (inst *StartPingPong) SetFeeTokenMintAccount(feeTokenMint ag_solanago.PublicKey) *StartPingPong {
	inst.AccountMetaSlice[5] = ag_solanago.Meta(feeTokenMint)
	return inst
}
...
func (inst *StartPingPong) SetFeeTokenAtaAccount(feeTokenAta ag_solanago.PublicKey) *StartPingPong {
	inst.AccountMetaSlice[6] = ag_solanago.Meta(feeTokenAta).WRITE()
	return inst
}
...
func (inst *StartPingPong) SetCcipRouterProgramAccount(ccipRouterProgram ag_solanago.PublicKey) *StartPingPong {
	inst.AccountMetaSlice[7] = ag_solanago.Meta(ccipRouterProgram)
	return inst
}
...
func (inst *StartPingPong) SetCcipRouterConfigAccount(ccipRouterConfig ag_solanago.PublicKey) *StartPingPong {
	inst.AccountMetaSlice[8] = ag_solanago.Meta(ccipRouterConfig)
	return inst
}
...
func (inst *StartPingPong) SetCcipRouterDestChainStateAccount(ccipRouterDestChainState ag_solanago.PublicKey) *StartPingPong {
	inst.AccountMetaSlice[9] = ag_solanago.Meta(ccipRouterDestChainState).WRITE()
	return inst
}
...
func (inst *StartPingPong) SetCcipRouterNonceAccount(ccipRouterNonce ag_solanago.PublicKey) *StartPingPong {
	inst.AccountMetaSlice[10] = ag_solanago.Meta(ccipRouterNonce).WRITE()
	return inst
}
...
func (inst *StartPingPong) SetCcipRouterFeeReceiverAccount(ccipRouterFeeReceiver ag_solanago.PublicKey) *StartPingPong {
	inst.AccountMetaSlice[11] = ag_solanago.Meta(ccipRouterFeeReceiver).WRITE()
	return inst
}
...
func (inst *StartPingPong) SetCcipRouterFeeBillingSignerAccount(ccipRouterFeeBillingSigner ag_solanago.PublicKey) *StartPingPong {
	inst.AccountMetaSlice[12] = ag_solanago.Meta(ccipRouterFeeBillingSigner)
	return inst
}
...
func (inst *StartPingPong) SetFeeQuoterAccount(feeQuoter ag_solanago.PublicKey) *StartPingPong {
	inst.AccountMetaSlice[13] = ag_solanago.Meta(feeQuoter)
	return inst
}
...
func (inst *StartPingPong) SetFeeQuoterConfigAccount(feeQuoterConfig ag_solanago.PublicKey) *StartPingPong {
	inst.AccountMetaSlice[14] = ag_solanago.Meta(feeQuoterConfig)
	return inst
}
...
func (inst *StartPingPong) SetFeeQuoterDestChainAccount(feeQuoterDestChain ag_solanago.PublicKey) *StartPingPong {
	inst.AccountMetaSlice[15] = ag_solanago.Meta(feeQuoterDestChain)
	return inst
}
...
func (inst *StartPingPong) SetFeeQuoterBillingTokenConfigAccount(feeQuoterBillingTokenConfig ag_solanago.PublicKey) *StartPingPong {
	inst.AccountMetaSlice[16] = ag_solanago.Meta(feeQuoterBillingTokenConfig)
	return inst
}
...
func (inst *StartPingPong) SetFeeQuoterLinkTokenConfigAccount(feeQuoterLinkTokenConfig ag_solanago.PublicKey) *StartPingPong {
	inst.AccountMetaSlice[17] = ag_solanago.Meta(feeQuoterLinkTokenConfig)
	return inst
}
...
func (inst *StartPingPong) SetRmnRemoteAccount(rmnRemote ag_solanago.PublicKey) *StartPingPong {
	inst.AccountMetaSlice[18] = ag_solanago.Meta(rmnRemote)
	return inst
}
...
func (inst *StartPingPong) SetRmnRemoteCursesAccount(rmnRemoteCurses ag_solanago.PublicKey) *StartPingPong {
	inst.AccountMetaSlice[19] = ag_solanago.Meta(rmnRemoteCurses)
	return inst
}
...
func (inst *StartPingPong) SetRmnRemoteConfigAccount(rmnRemoteConfig ag_solanago.PublicKey) *StartPingPong {
	inst.AccountMetaSlice[20] = ag_solanago.Meta(rmnRemoteConfig)
	return inst
}
...
func (inst *StartPingPong) SetTokenPoolsSignerAccount(tokenPoolsSigner ag_solanago.PublicKey) *StartPingPong {
	inst.AccountMetaSlice[21] = ag_solanago.Meta(tokenPoolsSigner).WRITE()
	return inst
}
			...
			programBranch.Child(ag_format.Instruction("StartPingPong")).
				...
				ParentFunc(func(instructionBranch ag_treeout.Branches) {
					...
					instructionBranch.Child("Accounts[len=23]").ParentFunc(func(accountsBranch ag_treeout.Branches) {
						...
						accountsBranch.Child(ag_format.Meta("             ccipSendSigner", inst.AccountMetaSlice[3]))
						accountsBranch.Child(ag_format.Meta("            feeTokenProgram", inst.AccountMetaSlice[4]))
						accountsBranch.Child(ag_format.Meta("               feeTokenMint", inst.AccountMetaSlice[5]))
						accountsBranch.Child(ag_format.Meta("                feeTokenAta", inst.AccountMetaSlice[6]))
						accountsBranch.Child(ag_format.Meta("          ccipRouterProgram", inst.AccountMetaSlice[7]))
						accountsBranch.Child(ag_format.Meta("           ccipRouterConfig", inst.AccountMetaSlice[8]))
						accountsBranch.Child(ag_format.Meta("   ccipRouterDestChainState", inst.AccountMetaSlice[9]))
						accountsBranch.Child(ag_format.Meta("            ccipRouterNonce", inst.AccountMetaSlice[10]))
						accountsBranch.Child(ag_format.Meta("      ccipRouterFeeReceiver", inst.AccountMetaSlice[11]))
						accountsBranch.Child(ag_format.Meta(" ccipRouterFeeBillingSigner", inst.AccountMetaSlice[12]))
						accountsBranch.Child(ag_format.Meta("                  feeQuoter", inst.AccountMetaSlice[13]))
						accountsBranch.Child(ag_format.Meta("            feeQuoterConfig", inst.AccountMetaSlice[14]))
						accountsBranch.Child(ag_format.Meta("         feeQuoterDestChain", inst.AccountMetaSlice[15]))
						accountsBranch.Child(ag_format.Meta("feeQuoterBillingTokenConfig", inst.AccountMetaSlice[16]))
						accountsBranch.Child(ag_format.Meta("   feeQuoterLinkTokenConfig", inst.AccountMetaSlice[17]))
						accountsBranch.Child(ag_format.Meta("                  rmnRemote", inst.AccountMetaSlice[18]))
						accountsBranch.Child(ag_format.Meta("            rmnRemoteCurses", inst.AccountMetaSlice[19]))
						accountsBranch.Child(ag_format.Meta("            rmnRemoteConfig", inst.AccountMetaSlice[20]))
						accountsBranch.Child(ag_format.Meta("           tokenPoolsSigner", inst.AccountMetaSlice[21]))
