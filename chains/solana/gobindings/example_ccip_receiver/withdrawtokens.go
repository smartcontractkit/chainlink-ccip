...
func (inst *WithdrawTokensInstruction) SetTokenAdminAccount(tokenAdmin ag_solanago.PublicKey) *WithdrawTokensInstruction {
	inst.AccountMetaSlice[5] = ag_solanago.Meta(tokenAdmin)
	return inst
}

// GetTokenAdminAccount gets the "token_admin" account.
func (inst *WithdrawTokensInstruction) GetTokenAdminAccount() *ag_solanago.AccountMeta {
