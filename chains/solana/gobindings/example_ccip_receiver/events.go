...
var MessageReceivedEventDataDiscriminator = [8]byte{231, 68, 47, 77, 173, 241, 157, 166}

func (obj MessageReceivedEventData) MarshalWithEncoder(encoder *ag_binary.Encoder) (err error) {
	// Write account discriminator:
	err = encoder.WriteBytes(MessageReceivedEventDataDiscriminator[:], false)
	if err != nil {
		return err
	}
...
func (obj *MessageReceivedEventData) UnmarshalWithDecoder(decoder *ag_binary.Decoder) (err error) {
	// Read and check account discriminator:
	{
		...
		if !discriminator.Equal(MessageReceivedEventDataDiscriminator[:]) {
			return fmt.Errorf(
				"wrong discriminator: wanted %s, got %s",
				"[231 68 47 77 173 241 157 166]",
...
func (*MessageReceivedEventData) isEventData() {}
func (obj *MessageReceivedEventData) Self() any {
	return obj
}

var eventTypes = map[[8]byte]reflect.Type{MessageReceivedEventDataDiscriminator: reflect.TypeOf(MessageReceivedEventData{})}
var eventNames = map[[8]byte]string{MessageReceivedEventDataDiscriminator: "MessageReceived"}
var (
	_ fmt.Formatter = nil
)
var (
