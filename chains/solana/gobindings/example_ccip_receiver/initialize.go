...
func (inst *InitializeInstruction) SetTokenAdminAccount(tokenAdmin ag_solanago.PublicKey) *InitializeInstruction {
	inst.AccountMetaSlice[1] = ag_solanago.Meta(tokenAdmin).WRITE()
	return inst
}

// GetTokenAdminAccount gets the "token_admin" account.
func (inst *InitializeInstruction) GetTokenAdminAccount() *ag_solanago.AccountMeta {
			...
			programBranch.Child(ag_format.Instruction("Initialize")).
				...
				ParentFunc(func(instructionBranch ag_treeout.Branches) {
					...
					instructionBranch.Child("Accounts[len=4]").ParentFunc(func(accountsBranch ag_treeout.Branches) {
						...
						accountsBranch.Child(ag_format.Meta("   token_admin", inst.AccountMetaSlice.Get(1)))
