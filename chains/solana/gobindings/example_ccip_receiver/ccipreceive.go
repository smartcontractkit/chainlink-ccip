...
func (inst *CcipReceiveInstruction) SetApprovedSenderAccount(approvedSender ag_solanago.PublicKey) *CcipReceiveInstruction {
	inst.AccountMetaSlice[3] = ag_solanago.Meta(approvedSender)
	return inst
}

// GetApprovedSenderAccount gets the "approved_sender" account.
func (inst *CcipReceiveInstruction) GetApprovedSenderAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(3)
}

// SetStateAccount sets the "state" account.
func (inst *CcipReceiveInstruction) SetStateAccount(state ag_solanago.PublicKey) *CcipReceiveInstruction {
	inst.AccountMetaSlice[4] = ag_solanago.Meta(state)
	return inst
}

// GetStateAccount gets the "state" account.
func (inst *CcipReceiveInstruction) GetStateAccount() *ag_solanago.AccountMeta {
...
func NewCcipReceiveInstruction(
	...
	state ag_solanago.PublicKey) *CcipReceiveInstruction {
