...
// SetMessage sets the "_message" parameter.
func (inst *CcipReceiveInstruction) SetMessage(_message Any2SVMMessage) *CcipReceiveInstruction {
			...
			programBranch.Child(ag_format.Instruction("CcipReceive")).
				...
				ParentFunc(func(instructionBranch ag_treeout.Branches) {
					...
					instructionBranch.Child("Accounts[len=5]").ParentFunc(func(accountsBranch ag_treeout.Branches) {
						...
						accountsBranch.Child(ag_format.Meta("        counter", inst.AccountMetaSlice.Get(3)))
