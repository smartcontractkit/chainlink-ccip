...
// NewAddDestChainInstructionBuilder creates a new `AddDestChainInstruction` instruction builder.
func NewAddDestChainInstructionBuilder() *AddDestChainInstruction {
	nd := &AddDestChainInstruction{
...
func (inst *AddDestChainInstruction) SetChainSelector(chain_selector uint64) *AddDestChainInstruction {
	inst.ChainSelector = &chain_selector
	return inst
}

// SetDestChainConfig sets the "dest_chain_config" parameter.
func (inst *AddDestChainInstruction) SetDestChainConfig(dest_chain_config DestChainConfig) *AddDestChainInstruction {
	inst.DestChainConfig = &dest_chain_config
	return inst
}

// SetConfigAccount sets the "config" account.
func (inst *AddDestChainInstruction) SetConfigAccount(config ag_solanago.PublicKey) *AddDestChainInstruction {
	inst.AccountMetaSlice[0] = ag_solanago.Meta(config)
	return inst
}

// GetConfigAccount gets the "config" account.
func (inst *AddDestChainInstruction) GetConfigAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(0)
}

// SetDestChainAccount sets the "dest_chain" account.
func (inst *AddDestChainInstruction) SetDestChainAccount(destChain ag_solanago.PublicKey) *AddDestChainInstruction {
	inst.AccountMetaSlice[1] = ag_solanago.Meta(destChain).WRITE()
	return inst
}

// GetDestChainAccount gets the "dest_chain" account.
func (inst *AddDestChainInstruction) GetDestChainAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(1)
}

// SetAuthorityAccount sets the "authority" account.
func (inst *AddDestChainInstruction) SetAuthorityAccount(authority ag_solanago.PublicKey) *AddDestChainInstruction {
	inst.AccountMetaSlice[2] = ag_solanago.Meta(authority).WRITE().SIGNER()
	return inst
}

// GetAuthorityAccount gets the "authority" account.
func (inst *AddDestChainInstruction) GetAuthorityAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(2)
}

// SetSystemProgramAccount sets the "system_program" account.
func (inst *AddDestChainInstruction) SetSystemProgramAccount(systemProgram ag_solanago.PublicKey) *AddDestChainInstruction {
	inst.AccountMetaSlice[3] = ag_solanago.Meta(systemProgram)
	return inst
}

// GetSystemProgramAccount gets the "system_program" account.
func (inst *AddDestChainInstruction) GetSystemProgramAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(3)
}

func (inst AddDestChainInstruction) Build() *Instruction {
...
func (inst AddDestChainInstruction) ValidateAndBuild() (*Instruction, error) {
...
func (inst *AddDestChainInstruction) Validate() error {
...
func (inst *AddDestChainInstruction) EncodeToTree(parent ag_treeout.Branches) {
...
func (obj AddDestChainInstruction) MarshalWithEncoder(encoder *ag_binary.Encoder) (err error) {
...
func (obj *AddDestChainInstruction) UnmarshalWithDecoder(decoder *ag_binary.Decoder) (err error) {
...
func NewAddDestChainInstruction(
	...
	systemProgram ag_solanago.PublicKey) *AddDestChainInstruction {
