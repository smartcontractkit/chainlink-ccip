...
// FinalizeBypasserOperation is the `finalize_bypasser_operation` instruction.
...
func (inst *FinalizeBypasserOperation) SetTimelockId(timelock_id [32]uint8) *FinalizeBypasserOperation {
