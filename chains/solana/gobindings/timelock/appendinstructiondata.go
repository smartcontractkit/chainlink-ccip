...
// NewAppendInstructionDataInstructionBuilder creates a new `AppendInstructionDataInstruction` instruction builder.
func NewAppendInstructionDataInstructionBuilder() *AppendInstructionDataInstruction {
	nd := &AppendInstructionDataInstruction{
...
func (inst *AppendInstructionDataInstruction) SetTimelockId(_timelock_id [32]uint8) *AppendInstructionDataInstruction {
	inst.TimelockId = &_timelock_id
	return inst
}

// SetId sets the "_id" parameter.
func (inst *AppendInstructionDataInstruction) SetId(_id [32]uint8) *AppendInstructionDataInstruction {
	inst.Id = &_id
	return inst
}

// SetIxIndex sets the "ix_index" parameter.
func (inst *AppendInstructionDataInstruction) SetIxIndex(ix_index uint32) *AppendInstructionDataInstruction {
	inst.IxIndex = &ix_index
	return inst
}

// SetIxDataChunk sets the "ix_data_chunk" parameter.
func (inst *AppendInstructionDataInstruction) SetIxDataChunk(ix_data_chunk []byte) *AppendInstructionDataInstruction {
	inst.IxDataChunk = &ix_data_chunk
	return inst
}

// SetOperationAccount sets the "operation" account.
func (inst *AppendInstructionDataInstruction) SetOperationAccount(operation ag_solanago.PublicKey) *AppendInstructionDataInstruction {
	inst.AccountMetaSlice[0] = ag_solanago.Meta(operation).WRITE()
	return inst
}

// GetOperationAccount gets the "operation" account.
func (inst *AppendInstructionDataInstruction) GetOperationAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(0)
}

// SetConfigAccount sets the "config" account.
func (inst *AppendInstructionDataInstruction) SetConfigAccount(config ag_solanago.PublicKey) *AppendInstructionDataInstruction {
	inst.AccountMetaSlice[1] = ag_solanago.Meta(config)
	return inst
}

// GetConfigAccount gets the "config" account.
func (inst *AppendInstructionDataInstruction) GetConfigAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(1)
}

// SetRoleAccessControllerAccount sets the "role_access_controller" account.
func (inst *AppendInstructionDataInstruction) SetRoleAccessControllerAccount(roleAccessController ag_solanago.PublicKey) *AppendInstructionDataInstruction {
...
func (inst *AppendInstructionDataInstruction) GetRoleAccessControllerAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(2)
}

// SetAuthorityAccount sets the "authority" account.
func (inst *AppendInstructionDataInstruction) SetAuthorityAccount(authority ag_solanago.PublicKey) *AppendInstructionDataInstruction {
	inst.AccountMetaSlice[3] = ag_solanago.Meta(authority).WRITE().SIGNER()
	return inst
}

// GetAuthorityAccount gets the "authority" account.
func (inst *AppendInstructionDataInstruction) GetAuthorityAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(3)
}

// SetSystemProgramAccount sets the "system_program" account.
func (inst *AppendInstructionDataInstruction) SetSystemProgramAccount(systemProgram ag_solanago.PublicKey) *AppendInstructionDataInstruction {
	inst.AccountMetaSlice[4] = ag_solanago.Meta(systemProgram)
	return inst
}

// GetSystemProgramAccount gets the "system_program" account.
func (inst *AppendInstructionDataInstruction) GetSystemProgramAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(4)
}

func (inst AppendInstructionDataInstruction) Build() *Instruction {
...
func (inst AppendInstructionDataInstruction) ValidateAndBuild() (*Instruction, error) {
...
func (inst *AppendInstructionDataInstruction) Validate() error {
...
func (inst *AppendInstructionDataInstruction) EncodeToTree(parent ag_treeout.Branches) {
...
func (obj AppendInstructionDataInstruction) MarshalWithEncoder(encoder *ag_binary.Encoder) (err error) {
...
func (obj *AppendInstructionDataInstruction) UnmarshalWithDecoder(decoder *ag_binary.Decoder) (err error) {
...
func NewAppendInstructionDataInstruction(
	...
	systemProgram ag_solanago.PublicKey) *AppendInstructionDataInstruction {
