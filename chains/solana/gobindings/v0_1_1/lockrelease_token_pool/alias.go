package lockrelease_token_pool // revive:disable-line:var-naming

import (
	base "github.com/smartcontractkit/chainlink-ccip/chains/solana/gobindings/v0_1_1/base_token_pool"
)
