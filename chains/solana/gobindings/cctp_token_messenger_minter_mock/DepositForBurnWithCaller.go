...
package cctp_token_messenger_minter_mock
			...
			programBranch.Child(ag_format.Instruction("DepositForBurnWithCaller")).
				...
				ParentFunc(func(instructionBranch ag_treeout.Branches) {
					...
					instructionBranch.Child("Accounts[len=17]").ParentFunc(func(accountsBranch ag_treeout.Branches) {
						...
						accountsBranch.Child(ag_format.Meta("             eventRentPayer", inst.AccountMetaSlice[1]))
						accountsBranch.Child(ag_format.Meta("         senderAuthorityPda", inst.AccountMetaSlice[2]))
						accountsBranch.Child(ag_format.Meta("                  burnToken", inst.AccountMetaSlice[3]))
						accountsBranch.Child(ag_format.Meta("         messageTransmitter", inst.AccountMetaSlice[4]))
						accountsBranch.Child(ag_format.Meta("             tokenMessenger", inst.AccountMetaSlice[5]))
						accountsBranch.Child(ag_format.Meta("       remoteTokenMessenger", inst.AccountMetaSlice[6]))
						accountsBranch.Child(ag_format.Meta("                tokenMinter", inst.AccountMetaSlice[7]))
						accountsBranch.Child(ag_format.Meta("                 localToken", inst.AccountMetaSlice[8]))
						accountsBranch.Child(ag_format.Meta("              burnTokenMint", inst.AccountMetaSlice[9]))
						accountsBranch.Child(ag_format.Meta("       messageSentEventData", inst.AccountMetaSlice[10]))
						accountsBranch.Child(ag_format.Meta("  messageTransmitterProgram", inst.AccountMetaSlice[11]))
						accountsBranch.Child(ag_format.Meta("tokenMessengerMinterProgram", inst.AccountMetaSlice[12]))
						...
						accountsBranch.Child(ag_format.Meta("             eventAuthority", inst.AccountMetaSlice[15]))
						accountsBranch.Child(ag_format.Meta("                    program", inst.AccountMetaSlice[16]))
					})
				})
		})
}
