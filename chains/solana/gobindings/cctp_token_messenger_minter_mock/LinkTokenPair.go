...
func (inst *LinkTokenPair) SetTokenPairAccount(tokenPair ag_solanago.PublicKey) *LinkTokenPair {
	inst.AccountMetaSlice[3] = ag_solanago.Meta(tokenPair).WRITE().SIGNER()
	return inst
}
			...
			programBranch.Child(ag_format.Instruction("LinkTokenPair")).
				...
				ParentFunc(func(instructionBranch ag_treeout.Branches) {
					...
					instructionBranch.Child("Accounts[len=7]").ParentFunc(func(accountsBranch ag_treeout.Branches) {
						...
						accountsBranch.Child(ag_format.Meta("      tokenPair", inst.AccountMetaSlice[3]))
						accountsBranch.Child(ag_format.Meta("  systemProgram", inst.AccountMetaSlice[4]))
						accountsBranch.Child(ag_format.Meta(" eventAuthority", inst.AccountMetaSlice[5]))
