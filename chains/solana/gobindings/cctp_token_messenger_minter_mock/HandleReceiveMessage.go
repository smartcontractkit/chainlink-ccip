			...
			programBranch.Child(ag_format.Instruction("HandleReceiveMessage")).
				...
				ParentFunc(func(instructionBranch ag_treeout.Branches) {
					...
					instructionBranch.Child("Accounts[len=11]").ParentFunc(func(accountsBranch ag_treeout.Branches) {
						accountsBranch.Child(ag_format.Meta("        authorityPda", inst.AccountMetaSlice[0]))
						accountsBranch.Child(ag_format.Meta("      tokenMessenger", inst.AccountMetaSlice[1]))
						accountsBranch.Child(ag_format.Meta("remoteTokenMessenger", inst.AccountMetaSlice[2]))
						accountsBranch.Child(ag_format.Meta("         tokenMinter", inst.AccountMetaSlice[3]))
						accountsBranch.Child(ag_format.Meta("          localToken", inst.AccountMetaSlice[4]))
						accountsBranch.Child(ag_format.Meta("           tokenPair", inst.AccountMetaSlice[5]))
						accountsBranch.Child(ag_format.Meta("      recipientToken", inst.AccountMetaSlice[6]))
						accountsBranch.Child(ag_format.Meta("        custodyToken", inst.AccountMetaSlice[7]))
						accountsBranch.Child(ag_format.Meta("        tokenProgram", inst.AccountMetaSlice[8]))
						accountsBranch.Child(ag_format.Meta("      eventAuthority", inst.AccountMetaSlice[9]))
