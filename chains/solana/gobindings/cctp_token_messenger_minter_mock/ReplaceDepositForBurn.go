			...
			programBranch.Child(ag_format.Instruction("ReplaceDepositForBurn")).
				...
				ParentFunc(func(instructionBranch ag_treeout.Branches) {
					...
					instructionBranch.Child("Accounts[len=11]").ParentFunc(func(accountsBranch ag_treeout.Branches) {
						...
						accountsBranch.Child(ag_format.Meta("             tokenMessenger", inst.AccountMetaSlice[4]))
						accountsBranch.Child(ag_format.Meta("       messageSentEventData", inst.AccountMetaSlice[5]))
						accountsBranch.Child(ag_format.Meta("  messageTransmitterProgram", inst.AccountMetaSlice[6]))
						accountsBranch.Child(ag_format.Meta("tokenMessengerMinterProgram", inst.AccountMetaSlice[7]))
