...
var MessageSentEventDataDiscriminator = [8]byte{116, 70, 224, 76, 128, 28, 110, 55}

func (obj MessageSentEventData) MarshalWithEncoder(encoder *ag_binary.Encoder) (err error) {
	// Write account discriminator:
	err = encoder.WriteBytes(MessageSentEventDataDiscriminator[:], false)
	if err != nil {
		return err
	}
...
func (obj *MessageSentEventData) UnmarshalWithDecoder(decoder *ag_binary.Decoder) (err error) {
	// Read and check account discriminator:
	{
		...
		if !discriminator.Equal(MessageSentEventDataDiscriminator[:]) {
			return fmt.Errorf(
				"wrong discriminator: wanted %s, got %s",
				"[116 70 224 76 128 28 110 55]",
...
func (*MessageSentEventData) isEventData() {}
func (obj *MessageSentEventData) Self() any {
	return obj
}

var eventTypes = map[[8]byte]reflect.Type{MessageSentEventDataDiscriminator: reflect.TypeOf(MessageSentEventData{})}
var eventNames = map[[8]byte]string{MessageSentEventDataDiscriminator: "MessageSent"}
var (
	_ fmt.Formatter = nil
)
var (
