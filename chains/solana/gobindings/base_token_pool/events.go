...
func (obj *BurnedEventData) Self() any {
	return obj
}
...
func (obj *ConfigChangedEventData) Self() any {
	return obj
}

type GlobalConfigUpdatedEventData struct {
	SelfServedAllowed bool
}

var GlobalConfigUpdatedEventDataDiscriminator = [8]byte{232, 238, 158, 123, 210, 172, 159, 46}

func (obj GlobalConfigUpdatedEventData) MarshalWithEncoder(encoder *ag_binary.Encoder) (err error) {
	// Write account discriminator:
	err = encoder.WriteBytes(GlobalConfigUpdatedEventDataDiscriminator[:], false)
	if err != nil {
		return err
	}
...
func (obj *GlobalConfigUpdatedEventData) UnmarshalWithDecoder(decoder *ag_binary.Decoder) (err error) {
	// Read and check account discriminator:
	{
		discriminator, err := decoder.ReadTypeID()
		if err != nil {
		...
		if !discriminator.Equal(GlobalConfigUpdatedEventDataDiscriminator[:]) {
			return fmt.Errorf(
				"wrong discriminator: wanted %s, got %s",
				"[232 238 158 123 210 172 159 46]",
				fmt.Sprint(discriminator[:]))
		}
	}
...
func (*GlobalConfigUpdatedEventData) isEventData() {}
func (obj *GlobalConfigUpdatedEventData) Self() any {
	return obj
}
...
func (obj *LockedEventData) Self() any {
	return obj
}

type MintAuthorityTransferredEventData struct {
	Mint             ag_solanago.PublicKey
	OldMintAuthority ag_solanago.PublicKey
	NewMintAuthority ag_solanago.PublicKey
}

var MintAuthorityTransferredEventDataDiscriminator = [8]byte{23, 136, 155, 223, 27, 166, 51, 85}

func (obj MintAuthorityTransferredEventData) MarshalWithEncoder(encoder *ag_binary.Encoder) (err error) {
	// Write account discriminator:
	err = encoder.WriteBytes(MintAuthorityTransferredEventDataDiscriminator[:], false)
	if err != nil {
		return err
	}
	// Serialize `Mint` param:
...
func (obj *MintAuthorityTransferredEventData) UnmarshalWithDecoder(decoder *ag_binary.Decoder) (err error) {
	// Read and check account discriminator:
	{
		discriminator, err := decoder.ReadTypeID()
		if err != nil {
		...
		if !discriminator.Equal(MintAuthorityTransferredEventDataDiscriminator[:]) {
			return fmt.Errorf(
				"wrong discriminator: wanted %s, got %s",
				"[23 136 155 223 27 166 51 85]",
				fmt.Sprint(discriminator[:]))
		}
	}
	// Deserialize `Mint`:
...
func (*MintAuthorityTransferredEventData) isEventData() {}
func (obj *MintAuthorityTransferredEventData) Self() any {
	return obj
}
...
func (obj *MintedEventData) Self() any {
	return obj
}
...
func (obj *RateLimitConfiguredEventData) Self() any {
	return obj
}
...
func (obj *ReleasedEventData) Self() any {
	return obj
}
...
func (obj *RemoteChainConfiguredEventData) Self() any {
	return obj
}
...
func (obj *RemoteChainRemovedEventData) Self() any {
	return obj
}
...
func (obj *RemotePoolsAppendedEventData) Self() any {
	return obj
}
...
func (obj *RouterUpdatedEventData) Self() any {
	return obj
}
...
func (obj *TokensConsumedEventData) Self() any {
	return obj
}
...
var eventTypes = map[[8]byte]reflect.Type{
	...
	GlobalConfigUpdatedEventDataDiscriminator:        reflect.TypeOf(GlobalConfigUpdatedEventData{}),
	LockedEventDataDiscriminator:                     reflect.TypeOf(LockedEventData{}),
	MintAuthorityTransferredEventDataDiscriminator:   reflect.TypeOf(MintAuthorityTransferredEventData{}),
...
var eventNames = map[[8]byte]string{
	...
	GlobalConfigUpdatedEventDataDiscriminator:        "GlobalConfigUpdated",
	LockedEventDataDiscriminator:                     "Locked",
	MintAuthorityTransferredEventDataDiscriminator:   "MintAuthorityTransferred",
