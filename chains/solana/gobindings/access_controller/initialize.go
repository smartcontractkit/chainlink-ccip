...
func (inst *InitializeInstruction) SetOwnerAccount(owner ag_solanago.PublicKey) *InitializeInstruction {
	inst.AccountMetaSlice[1] = ag_solanago.Meta(owner).SIGNER()
	return inst
}

// GetOwnerAccount gets the "owner" account.
func (inst *InitializeInstruction) GetOwnerAccount() *ag_solanago.AccountMeta {
...
func NewInitializeInstruction(
	...
	owner ag_solanago.PublicKey) *InitializeInstruction {
