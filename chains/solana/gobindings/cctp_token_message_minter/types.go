...
const (
	InvalidAuthority_TokenMinterError TokenMinterError = iota
	InvalidTokenMinterState_TokenMinterError
	ProgramPaused_TokenMinterError
	InvalidTokenPairState_TokenMinterError
	InvalidLocalTokenState_TokenMinterError
	InvalidPauser_TokenMinterError
	InvalidTokenController_TokenMinterError
	BurnAmountExceeded_TokenMinterError
	InvalidAmount_TokenMinterError
)

func (value TokenMinterError) String() string {
	switch value {
	case InvalidAuthority_TokenMinterError:
		return "InvalidAuthority"
	case InvalidTokenMinterState_TokenMinterError:
		return "InvalidTokenMinterState"
	case ProgramPaused_TokenMinterError:
		return "ProgramPaused"
	case InvalidTokenPairState_TokenMinterError:
		return "InvalidTokenPairState"
	case InvalidLocalTokenState_TokenMinterError:
		return "InvalidLocalTokenState"
	case InvalidPauser_TokenMinterError:
		return "InvalidPauser"
	case InvalidTokenController_TokenMinterError:
		return "InvalidTokenController"
	case BurnAmountExceeded_TokenMinterError:
		return "BurnAmountExceeded"
	case InvalidAmount_TokenMinterError:
