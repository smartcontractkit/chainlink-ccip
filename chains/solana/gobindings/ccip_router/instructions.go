...
var ProgramID ag_solanago.PublicKey = ag_solanago.MustPublicKeyFromBase58("Ccip842gzYHhvdDkSyi2YVCoAWPbYJoApMFzSxQroE9C")
...
var InstructionImplDef = ag_binary.NewVariantDefinition(
	...
	[]ag_binary.VariantType{
		{
			Name: "accept_admin_role_token_admin_registry", Type: (*AcceptAdminRoleTokenAdminRegistryInstruction)(nil),
		},
		{
			Name: "accept_ownership", Type: (*AcceptOwnershipInstruction)(nil),
		},
		{
			Name: "add_chain_selector", Type: (*AddChainSelectorInstruction)(nil),
		},
		{
			Name: "add_offramp", Type: (*AddOfframpInstruction)(nil),
		},
		{
			Name: "bump_ccip_version_for_dest_chain", Type: (*BumpCcipVersionForDestChainInstruction)(nil),
		},
		{
			Name: "ccip_admin_override_pending_administrator", Type: (*CcipAdminOverridePendingAdministratorInstruction)(nil),
		},
		{
			Name: "ccip_admin_propose_administrator", Type: (*CcipAdminProposeAdministratorInstruction)(nil),
		},
		{
			Name: "ccip_send", Type: (*CcipSendInstruction)(nil),
		},
		{
			Name: "get_fee", Type: (*GetFeeInstruction)(nil),
		},
		{
			Name: "initialize", Type: (*InitializeInstruction)(nil),
		},
		{
			Name: "owner_override_pending_administrator", Type: (*OwnerOverridePendingAdministratorInstruction)(nil),
		},
		{
			Name: "owner_propose_administrator", Type: (*OwnerProposeAdministratorInstruction)(nil),
		},
		{
			Name: "remove_offramp", Type: (*RemoveOfframpInstruction)(nil),
		},
		{
			Name: "rollback_ccip_version_for_dest_chain", Type: (*RollbackCcipVersionForDestChainInstruction)(nil),
		},
		{
			Name: "set_default_code_version", Type: (*SetDefaultCodeVersionInstruction)(nil),
		},
		{
			Name: "set_link_token_mint", Type: (*SetLinkTokenMintInstruction)(nil),
		},
		{
			Name: "set_pool", Type: (*SetPoolInstruction)(nil),
		},
		{
			Name: "transfer_admin_role_token_admin_registry", Type: (*TransferAdminRoleTokenAdminRegistryInstruction)(nil),
		},
		{
		...
		{
			Name: "update_dest_chain_config", Type: (*UpdateDestChainConfigInstruction)(nil),
		},
		{
			Name: "update_fee_aggregator", Type: (*UpdateFeeAggregatorInstruction)(nil),
		},
		{
			Name: "update_rmn_remote", Type: (*UpdateRmnRemoteInstruction)(nil),
		},
		{
			Name: "update_svm_chain_selector", Type: (*UpdateSvmChainSelectorInstruction)(nil),
		},
		{
			Name: "withdraw_billed_funds", Type: (*WithdrawBilledFundsInstruction)(nil),
		},
	},
)
