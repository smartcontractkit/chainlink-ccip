...
// NewBumpCcipVersionForDestChainInstructionBuilder creates a new `BumpCcipVersionForDestChainInstruction` instruction builder.
func NewBumpCcipVersionForDestChainInstructionBuilder() *BumpCcipVersionForDestChainInstruction {
	nd := &BumpCcipVersionForDestChainInstruction{
...
func (inst *BumpCcipVersionForDestChainInstruction) SetDestChainSelector(dest_chain_selector uint64) *BumpCcipVersionForDestChainInstruction {
	inst.DestChainSelector = &dest_chain_selector
	return inst
}

// SetDestChainStateAccount sets the "dest_chain_state" account.
func (inst *BumpCcipVersionForDestChainInstruction) SetDestChainStateAccount(destChainState ag_solanago.PublicKey) *BumpCcipVersionForDestChainInstruction {
	inst.AccountMetaSlice[0] = ag_solanago.Meta(destChainState).WRITE()
	return inst
}

// GetDestChainStateAccount gets the "dest_chain_state" account.
func (inst *BumpCcipVersionForDestChainInstruction) GetDestChainStateAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(0)
}

// SetConfigAccount sets the "config" account.
func (inst *BumpCcipVersionForDestChainInstruction) SetConfigAccount(config ag_solanago.PublicKey) *BumpCcipVersionForDestChainInstruction {
	inst.AccountMetaSlice[1] = ag_solanago.Meta(config)
	return inst
}

// GetConfigAccount gets the "config" account.
func (inst *BumpCcipVersionForDestChainInstruction) GetConfigAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(1)
}

// SetAuthorityAccount sets the "authority" account.
func (inst *BumpCcipVersionForDestChainInstruction) SetAuthorityAccount(authority ag_solanago.PublicKey) *BumpCcipVersionForDestChainInstruction {
	inst.AccountMetaSlice[2] = ag_solanago.Meta(authority).WRITE().SIGNER()
	return inst
}

// GetAuthorityAccount gets the "authority" account.
func (inst *BumpCcipVersionForDestChainInstruction) GetAuthorityAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(2)
}

func (inst BumpCcipVersionForDestChainInstruction) Build() *Instruction {
...
func (inst BumpCcipVersionForDestChainInstruction) ValidateAndBuild() (*Instruction, error) {
...
func (inst *BumpCcipVersionForDestChainInstruction) Validate() error {
...
func (inst *BumpCcipVersionForDestChainInstruction) EncodeToTree(parent ag_treeout.Branches) {
...
func (obj BumpCcipVersionForDestChainInstruction) MarshalWithEncoder(encoder *ag_binary.Encoder) (err error) {
...
func (obj *BumpCcipVersionForDestChainInstruction) UnmarshalWithDecoder(decoder *ag_binary.Decoder) (err error) {
...
func NewBumpCcipVersionForDestChainInstruction(
	...
	authority ag_solanago.PublicKey) *BumpCcipVersionForDestChainInstruction {
