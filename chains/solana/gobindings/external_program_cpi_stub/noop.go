...
// NewNoOpInstructionBuilder creates a new `NoOpInstruction` instruction builder.
func NewNoOpInstructionBuilder() *NoOpInstruction {
	nd := &NoOpInstruction{
...
func (inst NoOpInstruction) Build() *Instruction {
...
func (inst NoOpInstruction) ValidateAndBuild() (*Instruction, error) {
...
func (inst *NoOpInstruction) Validate() error {
...
func (inst *NoOpInstruction) EncodeToTree(parent ag_treeout.Branches) {
...
func (obj NoOpInstruction) MarshalWithEncoder(encoder *ag_binary.Encoder) (err error) {
	return nil
}
func (obj *NoOpInstruction) UnmarshalWithDecoder(decoder *ag_binary.Decoder) (err error) {
	return nil
}
