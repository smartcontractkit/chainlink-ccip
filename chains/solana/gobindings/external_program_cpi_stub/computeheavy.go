...
// ComputeHeavy is the `compute_heavy` instruction.
...
// NewComputeHeavyInstructionBuilder creates a new `ComputeHeavyInstruction` instruction builder.
func NewComputeHeavyInstructionBuilder() *ComputeHeavyInstruction {
	nd := &ComputeHeavyInstruction{
...
func (inst *ComputeHeavyInstruction) SetIterations(iterations uint32) *ComputeHeavyInstruction {
	inst.Iterations = &iterations
	return inst
}

func (inst ComputeHeavyInstruction) Build() *Instruction {
...
func (inst ComputeHeavyInstruction) ValidateAndBuild() (*Instruction, error) {
...
func (inst *ComputeHeavyInstruction) Validate() error {
...
func (inst *ComputeHeavyInstruction) EncodeToTree(parent ag_treeout.Branches) {
...
func (obj ComputeHeavyInstruction) MarshalWithEncoder(encoder *ag_binary.Encoder) (err error) {
...
func (obj *ComputeHeavyInstruction) UnmarshalWithDecoder(decoder *ag_binary.Decoder) (err error) {
...
func NewComputeHeavyInstruction(
	// Parameters:
	iterations uint32) *ComputeHeavyInstruction {
