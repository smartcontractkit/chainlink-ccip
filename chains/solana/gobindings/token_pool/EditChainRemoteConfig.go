...
func (inst *EditChainRemoteConfig) SetMint(_mint ag_solanago.PublicKey) *EditChainRemoteConfig {
	inst.Mint = &_mint
	return inst
}
...
func (inst *EditChainRemoteConfig) SetConfigAccount(config ag_solanago.PublicKey) *EditChainRemoteConfig {
	inst.AccountMetaSlice[0] = ag_solanago.Meta(config)
	return inst
}

// GetConfigAccount gets the "config" account.
func (inst *EditChainRemoteConfig) GetConfigAccount() *ag_solanago.AccountMeta {
