...
func (inst *InitChainRemoteConfig) SetRemoteChainSelector(remote_chain_selector uint64) *InitChainRemoteConfig {
	inst.RemoteChainSelector = &remote_chain_selector
	return inst
}

// SetMint sets the "_mint" parameter.
func (inst *InitChainRemoteConfig) SetMint(_mint ag_solanago.PublicKey) *InitChainRemoteConfig {
	inst.Mint = &_mint
	return inst
}
