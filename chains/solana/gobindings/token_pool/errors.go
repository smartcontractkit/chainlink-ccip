...
var (
	...
	Errors = map[int]CustomError{
		...
		6004: ErrInvalidSourcePoolAddress,
		6005: ErrInvalidToken,
		6006: ErrInvalidTokenAmountConversion,
		6007: ErrRLBucketOverfilled,
		6008: ErrRLMaxCapacityExceeded,
		6009: ErrRLRateLimitReached,
		6010: ErrRLInvalidRateLimitRate,
		6011: ErrRLDisabledNonZeroRateLimit,
	}
)
