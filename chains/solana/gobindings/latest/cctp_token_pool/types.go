...
type CctpChain struct {
	...
	DestinationCaller solanago.PublicKey `json:"destination_caller"`
}
...
type FundingConfig struct {
	...
	ReclaimDestination solanago.PublicKey `json:"reclaim_destination"`
	MinimumSignerFunds uint64             `json:"minimum_signer_funds"`
}
