...
type AdministratorTransferRequested struct {
	...
	CurrentAdmin solanago.PublicKey `json:"current_admin"`
...
type CcipVersionForDestChainVersionBumped struct {
	DestChainSelector      uint64 `json:"dest_chain_selector"`
	PreviousSequenceNumber uint64 `json:"previous_sequence_number"`
	NewSequenceNumber      uint64 `json:"new_sequence_number"`
}
...
type DeriveAccountsCcipSendParams struct {
	DestChainSelector uint64             `json:"dest_chain_selector"`
	CcipSendCaller    solanago.PublicKey `json:"ccip_send_caller"`
...
type DestChainConfig struct {
	...
	AllowedSenders   []solanago.PublicKey `json:"allowed_senders"`
...
type DestChainState struct {
	SequenceNumber          uint64          `json:"sequence_number"`
	SequenceNumberToRestore uint64          `json:"sequence_number_to_restore"`
	RestoreOnAction         RestoreOnAction `json:"restore_on_action"`
}
...
type IdlBuildTypeExport struct {
	Svm2AnyRampMessage   Svm2AnyRampMessage   `json:"svm2any_ramp_message"`
	Svm2AnyTokenTransfer Svm2AnyTokenTransfer `json:"svm2any_token_transfer"`
...
type Nonce struct {
	Version      uint8  `json:"version"`
	OrderedNonce uint64 `json:"ordered_nonce"`
	TotalNonce   uint64 `json:"total_nonce"`
}
...
type PoolSet struct {
	Token                   solanago.PublicKey `json:"token"`
	PreviousPoolLookupTable solanago.PublicKey `json:"previous_pool_lookup_table"`
	NewPoolLookupTable      solanago.PublicKey `json:"new_pool_lookup_table"`
}
