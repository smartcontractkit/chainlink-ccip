...
type Config struct {
	...
	CounterpartChainSelector uint64             `json:"counterpartChainSelector"`
	CounterpartAddress       CounterpartAddress `json:"counterpartAddress"`
	IsPaused                 bool               `json:"isPaused"`
	FeeTokenMint             solanago.PublicKey `json:"feeTokenMint"`
