...
func (obj Counter) MarshalWithEncoder(encoder *binary.Encoder) (err error) {
	...
	if err != nil {
		return errors.NewField("RejectAll", err)
	}
	// Serialize `State`:
...
func (obj ExternalExecutionConfig) MarshalWithEncoder(encoder *binary.Encoder) (err error) {
	return nil
}

func (obj ExternalExecutionConfig) Marshal() ([]byte, error) {
	buf := bytes.NewBuffer(nil)
	encoder := binary.NewBorshEncoder(buf)
	err := obj.MarshalWithEncoder(encoder)
	if err != nil {
		return nil, fmt.Errorf("error while encoding ExternalExecutionConfig: %w", err)
	}
	return buf.Bytes(), nil
}

func (obj *ExternalExecutionConfig) UnmarshalWithDecoder(decoder *binary.Decoder) (err error) {
	return nil
}

func (obj *ExternalExecutionConfig) Unmarshal(buf []byte) error {
	err := obj.UnmarshalWithDecoder(binary.NewBorshDecoder(buf))
	if err != nil {
		return fmt.Errorf("error while unmarshaling ExternalExecutionConfig: %w", err)
	}
	return nil
}

func UnmarshalExternalExecutionConfig(buf []byte) (*ExternalExecutionConfig, error) {
	obj := new(ExternalExecutionConfig)
	err := obj.Unmarshal(buf)
	if err != nil {
		return nil, err
	}
