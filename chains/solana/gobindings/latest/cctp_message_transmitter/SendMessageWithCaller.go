			...
			programBranch.Child(ag_format.Instruction("SendMessageWithCaller")).
				...
				ParentFunc(func(instructionBranch ag_treeout.Branches) {
					...
					instructionBranch.Child("Accounts[len=6]").ParentFunc(func(accountsBranch ag_treeout.Branches) {
						accountsBranch.Child(ag_format.Meta("      eventRentPayer", inst.AccountMetaSlice[0]))
						accountsBranch.Child(ag_format.Meta("  senderAuthorityPda", inst.AccountMetaSlice[1]))
						accountsBranch.Child(ag_format.Meta("  messageTransmitter", inst.AccountMetaSlice[2]))
						accountsBranch.Child(ag_format.Meta("messageSentEventData", inst.AccountMetaSlice[3]))
						accountsBranch.Child(ag_format.Meta("       senderProgram", inst.AccountMetaSlice[4]))
