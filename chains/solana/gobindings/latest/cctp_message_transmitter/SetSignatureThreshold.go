			...
			programBranch.Child(ag_format.Instruction("SetSignatureThreshold")).
				...
				ParentFunc(func(instructionBranch ag_treeout.Branches) {
					...
					instructionBranch.Child("Accounts[len=4]").ParentFunc(func(accountsBranch ag_treeout.Branches) {
						accountsBranch.Child(ag_format.Meta("   attesterManager", inst.AccountMetaSlice[0]))
						accountsBranch.Child(ag_format.Meta("messageTransmitter", inst.AccountMetaSlice[1]))
