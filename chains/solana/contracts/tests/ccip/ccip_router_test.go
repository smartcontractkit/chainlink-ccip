...
func TestCCIPRouter(t *testing.T) {
	...
	t.Run("setup", func(t *testing.T) {
		...
		t.Run("token-pool", func(t *testing.T) {
			...
			testutils.RetryOnStaleSlot(t, func() error { return token0.SetupLookupTable(ctx, solanaGoClient, token0PoolAdmin) })
			token0Entries := token0.ToTokenPoolEntries()
			testutils.RetryOnStaleSlot(t, func() error { return token1.SetupLookupTable(ctx, solanaGoClient, token1PoolAdmin) })
			token1Entries := token1.ToTokenPoolEntries()
			testutils.RetryOnStaleSlot(t, func() error { return token2.SetupLookupTable(ctx, solanaGoClient, token2PoolAdmin) })
			token2Entries := token2.ToTokenPoolEntries()
			testutils.RetryOnStaleSlot(t, func() error { return linkPool.SetupLookupTable(ctx, solanaGoClient, legacyAdmin) })
			...
			t.Run("CCTP USDC token pool", func(t *testing.T) {
				...
				// Lookup Table for Tokens
				testutils.RetryOnStaleSlot(t, func() error { return usdcPool.SetupLookupTable(ctx, solanaGoClient, usdcPoolAdmin) })
		...
		t.Run("Ccip Send address lookup table", func(t *testing.T) {
			...
			testutils.RetryOnStaleSlot(t, func() error {
				var err error
