...
/// IDL build version - simplified with UncheckedAccount since token_interface types
/// don't implement IdlBuild in Anchor 0.32
...
pub struct TokenAccountsValidationContext<'info> {
    /// CHECK: IDL placeholder - runtime uses InterfaceAccount<TokenAccount>
    ...
    /// CHECK: IDL placeholder - runtime uses Interface<TokenInterface>
    pub token_program: UncheckedAccount<'info>,
    /// CHECK: IDL placeholder - runtime uses InterfaceAccount<Mint>
...
/// Runtime version - full validation with InterfaceAccount types
#[cfg(not(feature = "idl-build"))]
#[derive(Accounts)]
#[instruction(token_receiver: Pubkey, chain_selector: u64, router: Pubkey, fee_quoter: Pubkey)]
pub struct TokenAccountsValidationContext<'info> {
