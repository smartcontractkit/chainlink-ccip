...
impl CommitInput {
    /// During IDL build, return a default MerkleRoot to allow seeds to compile.
    /// At runtime, this properly parses the raw data.
    #[cfg(feature = "idl-build")]
    pub fn root(_raw: &[u8]) -> Result<MerkleRoot> {
        Ok(MerkleRoot::default())
    }
