...
// todo: wip - no function or associated item named `id` found for struct `access_controller::AccessController` in the current scope --> programs/timelock/src/instructions/initialize.rs:66:10
pub struct AccessControllerProgram;

impl Id for AccessControllerProgram {
    fn id() -> Pubkey {
        ID //generated by the declare_id! macro above.
    }
}
