...
func (_CommitOffRamp *CommitOffRampTransactor) ValidateReport(opts *bind.TransactOpts, rawReport []byte, ccvBlob []byte, ocrProof []byte, arg3 *big.Int, originalState uint8) (*types.Transaction, error) {
	return _CommitOffRamp.contract.Transact(opts, "validateReport", rawReport, ccvBlob, ocrProof, arg3, originalState)
}

func (_CommitOffRamp *CommitOffRampSession) ValidateReport(rawReport []byte, ccvBlob []byte, ocrProof []byte, arg3 *big.Int, originalState uint8) (*types.Transaction, error) {
	return _CommitOffRamp.Contract.ValidateReport(&_CommitOffRamp.TransactOpts, rawReport, ccvBlob, ocrProof, arg3, originalState)
}

func (_CommitOffRamp *CommitOffRampTransactorSession) ValidateReport(rawReport []byte, ccvBlob []byte, ocrProof []byte, arg3 *big.Int, originalState uint8) (*types.Transaction, error) {
	return _CommitOffRamp.Contract.ValidateReport(&_CommitOffRamp.TransactOpts, rawReport, ccvBlob, ocrProof, arg3, originalState)
}
...
type CommitOffRampInterface interface {
	...
	ValidateReport(opts *bind.TransactOpts, rawReport []byte, ccvBlob []byte, ocrProof []byte, arg3 *big.Int, originalState uint8) (*types.Transaction, error)
