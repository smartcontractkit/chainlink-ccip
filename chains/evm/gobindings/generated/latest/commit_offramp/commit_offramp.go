...
func (_CommitOffRamp *CommitOffRampTransactor) VerifyMessage(opts *bind.TransactOpts, message MessageV1CodecMessageV1, messageHash [32]byte, ccvData []byte, originalState uint8) (*types.Transaction, error) {
	return _CommitOffRamp.contract.Transact(opts, "verifyMessage", message, messageHash, ccvData, originalState)
}

func (_CommitOffRamp *CommitOffRampSession) VerifyMessage(message MessageV1CodecMessageV1, messageHash [32]byte, ccvData []byte, originalState uint8) (*types.Transaction, error) {
	return _CommitOffRamp.Contract.VerifyMessage(&_CommitOffRamp.TransactOpts, message, messageHash, ccvData, originalState)
}

func (_CommitOffRamp *CommitOffRampTransactorSession) VerifyMessage(message MessageV1CodecMessageV1, messageHash [32]byte, ccvData []byte, originalState uint8) (*types.Transaction, error) {
	return _CommitOffRamp.Contract.VerifyMessage(&_CommitOffRamp.TransactOpts, message, messageHash, ccvData, originalState)
}
...
type CommitOffRampInterface interface {
	...
	VerifyMessage(opts *bind.TransactOpts, message MessageV1CodecMessageV1, messageHash [32]byte, ccvData []byte, originalState uint8) (*types.Transaction, error)
