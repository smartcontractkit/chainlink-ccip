...
func (_CommitOffRamp *CommitOffRampTransactor) ValidateReport(opts *bind.TransactOpts, rawReport []byte, ocrProof []byte, verifierIndex *big.Int, originalState uint8) (*types.Transaction, error) {
	return _CommitOffRamp.contract.Transact(opts, "validateReport", rawReport, ocrProof, verifierIndex, originalState)
}

func (_CommitOffRamp *CommitOffRampSession) ValidateReport(rawReport []byte, ocrProof []byte, verifierIndex *big.Int, originalState uint8) (*types.Transaction, error) {
	return _CommitOffRamp.Contract.ValidateReport(&_CommitOffRamp.TransactOpts, rawReport, ocrProof, verifierIndex, originalState)
}

func (_CommitOffRamp *CommitOffRampTransactorSession) ValidateReport(rawReport []byte, ocrProof []byte, verifierIndex *big.Int, originalState uint8) (*types.Transaction, error) {
	return _CommitOffRamp.Contract.ValidateReport(&_CommitOffRamp.TransactOpts, rawReport, ocrProof, verifierIndex, originalState)
}
