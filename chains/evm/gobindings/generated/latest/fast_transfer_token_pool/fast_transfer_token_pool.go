...
func (_BurnMintFastTransferTokenPool *BurnMintFastTransferTokenPoolCaller) GetCCVs(opts *bind.CallOpts, sourceChainSelector uint64) (GetCCVs,

	error) {
	var out []interface{}
	err := _BurnMintFastTransferTokenPool.contract.Call(opts, &out, "getCCVs", sourceChainSelector)
...
func (_BurnMintFastTransferTokenPool *BurnMintFastTransferTokenPoolSession) GetCCVs(sourceChainSelector uint64) (GetCCVs,

	error) {
	return _BurnMintFastTransferTokenPool.Contract.GetCCVs(&_BurnMintFastTransferTokenPool.CallOpts, sourceChainSelector)
}

func (_BurnMintFastTransferTokenPool *BurnMintFastTransferTokenPoolCallerSession) GetCCVs(sourceChainSelector uint64) (GetCCVs,
