...
func (_PingPongDemo *PingPongDemoCaller) GetCCVs(opts *bind.CallOpts, sourceChainSelector uint64) (GetCCVs,

	error) {
	var out []interface{}
	err := _PingPongDemo.contract.Call(opts, &out, "getCCVs", sourceChainSelector)
...
func (_PingPongDemo *PingPongDemoSession) GetCCVs(sourceChainSelector uint64) (GetCCVs,

	error) {
	return _PingPongDemo.Contract.GetCCVs(&_PingPongDemo.CallOpts, sourceChainSelector)
}

func (_PingPongDemo *PingPongDemoCallerSession) GetCCVs(sourceChainSelector uint64) (GetCCVs,
