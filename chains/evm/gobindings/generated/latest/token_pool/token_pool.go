...
func (_TokenPool *TokenPoolFilterer) FilterReleasedOrMinted(opts *bind.FilterOpts, remoteChainSelector []uint64, recipient []common.Address) (*TokenPoolReleasedOrMintedIterator, error) {
	...
	logs, sub, err := _TokenPool.contract.FilterLogs(opts, "ReleasedOrMinted", remoteChainSelectorRule, recipientRule)
	if err != nil {
		return nil, err
	}
...
func (_TokenPool *TokenPoolFilterer) WatchReleasedOrMinted(opts *bind.WatchOpts, sink chan<- *TokenPoolReleasedOrMinted, remoteChainSelector []uint64, recipient []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _TokenPool.contract.WatchLogs(opts, "ReleasedOrMinted", remoteChainSelectorRule, recipientRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
...
type TokenPoolInterface interface {
	...
	FilterReleasedOrMinted(opts *bind.FilterOpts, remoteChainSelector []uint64, recipient []common.Address) (*TokenPoolReleasedOrMintedIterator, error)

	WatchReleasedOrMinted(opts *bind.WatchOpts, sink chan<- *TokenPoolReleasedOrMinted, remoteChainSelector []uint64, recipient []common.Address) (event.Subscription, error)
