...
func (_TokenPool *TokenPoolCaller) GetCurrentCustomFinalityRateLimiterState(opts *bind.CallOpts, remoteChainSelector uint64, direction uint8) (RateLimiterTokenBucket, error) {
	var out []interface{}
	err := _TokenPool.contract.Call(opts, &out, "getCurrentCustomFinalityRateLimiterState", remoteChainSelector, direction)
...
func (_TokenPool *TokenPoolSession) GetCurrentCustomFinalityRateLimiterState(remoteChainSelector uint64, direction uint8) (RateLimiterTokenBucket, error) {
	return _TokenPool.Contract.GetCurrentCustomFinalityRateLimiterState(&_TokenPool.CallOpts, remoteChainSelector, direction)
}

func (_TokenPool *TokenPoolCallerSession) GetCurrentCustomFinalityRateLimiterState(remoteChainSelector uint64, direction uint8) (RateLimiterTokenBucket, error) {
	return _TokenPool.Contract.GetCurrentCustomFinalityRateLimiterState(&_TokenPool.CallOpts, remoteChainSelector, direction)
}

func (_TokenPool *TokenPoolCaller) GetCurrentRateLimiterState(opts *bind.CallOpts, remoteChainSelector uint64, direction uint8) (RateLimiterTokenBucket, error) {
	var out []interface{}
	err := _TokenPool.contract.Call(opts, &out, "getCurrentRateLimiterState", remoteChainSelector, direction)
...
func (_TokenPool *TokenPoolSession) GetCurrentRateLimiterState(remoteChainSelector uint64, direction uint8) (RateLimiterTokenBucket, error) {
	return _TokenPool.Contract.GetCurrentRateLimiterState(&_TokenPool.CallOpts, remoteChainSelector, direction)
}

func (_TokenPool *TokenPoolCallerSession) GetCurrentRateLimiterState(remoteChainSelector uint64, direction uint8) (RateLimiterTokenBucket, error) {
	return _TokenPool.Contract.GetCurrentRateLimiterState(&_TokenPool.CallOpts, remoteChainSelector, direction)
}

func (_TokenPool *TokenPoolCaller) GetCustomFinalityConfig(opts *bind.CallOpts) (GetCustomFinalityConfig,

	error) {
	var out []interface{}
	err := _TokenPool.contract.Call(opts, &out, "getCustomFinalityConfig")
...
func (_TokenPool *TokenPoolSession) GetCustomFinalityConfig() (GetCustomFinalityConfig,

	error) {
	return _TokenPool.Contract.GetCustomFinalityConfig(&_TokenPool.CallOpts)
}

func (_TokenPool *TokenPoolCallerSession) GetCustomFinalityConfig() (GetCustomFinalityConfig,
