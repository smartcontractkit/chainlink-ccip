...
func (_TokenPool *TokenPoolCaller) GetCurrentInboundCustomFinalityRateLimiterState(opts *bind.CallOpts, remoteChainSelector uint64) (RateLimiterTokenBucket, error) {
	var out []interface{}
	err := _TokenPool.contract.Call(opts, &out, "getCurrentInboundCustomFinalityRateLimiterState", remoteChainSelector)
...
func (_TokenPool *TokenPoolSession) GetCurrentInboundCustomFinalityRateLimiterState(remoteChainSelector uint64) (RateLimiterTokenBucket, error) {
	return _TokenPool.Contract.GetCurrentInboundCustomFinalityRateLimiterState(&_TokenPool.CallOpts, remoteChainSelector)
}

func (_TokenPool *TokenPoolCallerSession) GetCurrentInboundCustomFinalityRateLimiterState(remoteChainSelector uint64) (RateLimiterTokenBucket, error) {
	return _TokenPool.Contract.GetCurrentInboundCustomFinalityRateLimiterState(&_TokenPool.CallOpts, remoteChainSelector)
}
...
func (_TokenPool *TokenPoolCaller) GetCurrentOutboundCustomFinalityRateLimiterState(opts *bind.CallOpts, remoteChainSelector uint64) (RateLimiterTokenBucket, error) {
	var out []interface{}
	err := _TokenPool.contract.Call(opts, &out, "getCurrentOutboundCustomFinalityRateLimiterState", remoteChainSelector)
...
func (_TokenPool *TokenPoolSession) GetCurrentOutboundCustomFinalityRateLimiterState(remoteChainSelector uint64) (RateLimiterTokenBucket, error) {
	return _TokenPool.Contract.GetCurrentOutboundCustomFinalityRateLimiterState(&_TokenPool.CallOpts, remoteChainSelector)
}

func (_TokenPool *TokenPoolCallerSession) GetCurrentOutboundCustomFinalityRateLimiterState(remoteChainSelector uint64) (RateLimiterTokenBucket, error) {
	return _TokenPool.Contract.GetCurrentOutboundCustomFinalityRateLimiterState(&_TokenPool.CallOpts, remoteChainSelector)
}
