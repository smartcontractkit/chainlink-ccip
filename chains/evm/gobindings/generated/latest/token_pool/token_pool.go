...
func (_TokenPool *TokenPoolCaller) GetRequiredInboundCCVs(opts *bind.CallOpts, arg0 common.Address, sourceChainSelector uint64, arg2 *big.Int, arg3 uint16, arg4 []byte) ([]common.Address, error) {
	var out []interface{}
	err := _TokenPool.contract.Call(opts, &out, "getRequiredInboundCCVs", arg0, sourceChainSelector, arg2, arg3, arg4)
...
func (_TokenPool *TokenPoolSession) GetRequiredInboundCCVs(arg0 common.Address, sourceChainSelector uint64, arg2 *big.Int, arg3 uint16, arg4 []byte) ([]common.Address, error) {
	return _TokenPool.Contract.GetRequiredInboundCCVs(&_TokenPool.CallOpts, arg0, sourceChainSelector, arg2, arg3, arg4)
}

func (_TokenPool *TokenPoolCallerSession) GetRequiredInboundCCVs(arg0 common.Address, sourceChainSelector uint64, arg2 *big.Int, arg3 uint16, arg4 []byte) ([]common.Address, error) {
	return _TokenPool.Contract.GetRequiredInboundCCVs(&_TokenPool.CallOpts, arg0, sourceChainSelector, arg2, arg3, arg4)
}

func (_TokenPool *TokenPoolCaller) GetRequiredOutboundCCVs(opts *bind.CallOpts, arg0 common.Address, destChainSelector uint64, arg2 *big.Int, arg3 uint16, arg4 []byte) ([]common.Address, error) {
	var out []interface{}
	err := _TokenPool.contract.Call(opts, &out, "getRequiredOutboundCCVs", arg0, destChainSelector, arg2, arg3, arg4)
...
func (_TokenPool *TokenPoolSession) GetRequiredOutboundCCVs(arg0 common.Address, destChainSelector uint64, arg2 *big.Int, arg3 uint16, arg4 []byte) ([]common.Address, error) {
	return _TokenPool.Contract.GetRequiredOutboundCCVs(&_TokenPool.CallOpts, arg0, destChainSelector, arg2, arg3, arg4)
}

func (_TokenPool *TokenPoolCallerSession) GetRequiredOutboundCCVs(arg0 common.Address, destChainSelector uint64, arg2 *big.Int, arg3 uint16, arg4 []byte) ([]common.Address, error) {
	return _TokenPool.Contract.GetRequiredOutboundCCVs(&_TokenPool.CallOpts, arg0, destChainSelector, arg2, arg3, arg4)
}
...
func (_TokenPool *TokenPoolTransactor) ApplyFinalityConfigUpdates(opts *bind.TransactOpts, finalityThreshold uint16, fastTransferFeeBps uint16, maxAmountPerRequest *big.Int, rateLimitConfigArgs []TokenPoolFastFinalityRateLimitConfigArgs) (*types.Transaction, error) {
	return _TokenPool.contract.Transact(opts, "applyFinalityConfigUpdates", finalityThreshold, fastTransferFeeBps, maxAmountPerRequest, rateLimitConfigArgs)
}

func (_TokenPool *TokenPoolSession) ApplyFinalityConfigUpdates(finalityThreshold uint16, fastTransferFeeBps uint16, maxAmountPerRequest *big.Int, rateLimitConfigArgs []TokenPoolFastFinalityRateLimitConfigArgs) (*types.Transaction, error) {
	return _TokenPool.Contract.ApplyFinalityConfigUpdates(&_TokenPool.TransactOpts, finalityThreshold, fastTransferFeeBps, maxAmountPerRequest, rateLimitConfigArgs)
}

func (_TokenPool *TokenPoolTransactorSession) ApplyFinalityConfigUpdates(finalityThreshold uint16, fastTransferFeeBps uint16, maxAmountPerRequest *big.Int, rateLimitConfigArgs []TokenPoolFastFinalityRateLimitConfigArgs) (*types.Transaction, error) {
	return _TokenPool.Contract.ApplyFinalityConfigUpdates(&_TokenPool.TransactOpts, finalityThreshold, fastTransferFeeBps, maxAmountPerRequest, rateLimitConfigArgs)
}
...
func (_TokenPool *TokenPoolTransactor) SetFastFinalityRateLimitConfig(opts *bind.TransactOpts, rateLimitConfigArgs []TokenPoolFastFinalityRateLimitConfigArgs) (*types.Transaction, error) {
	return _TokenPool.contract.Transact(opts, "setFastFinalityRateLimitConfig", rateLimitConfigArgs)
}

func (_TokenPool *TokenPoolSession) SetFastFinalityRateLimitConfig(rateLimitConfigArgs []TokenPoolFastFinalityRateLimitConfigArgs) (*types.Transaction, error) {
	return _TokenPool.Contract.SetFastFinalityRateLimitConfig(&_TokenPool.TransactOpts, rateLimitConfigArgs)
}

func (_TokenPool *TokenPoolTransactorSession) SetFastFinalityRateLimitConfig(rateLimitConfigArgs []TokenPoolFastFinalityRateLimitConfigArgs) (*types.Transaction, error) {
	return _TokenPool.Contract.SetFastFinalityRateLimitConfig(&_TokenPool.TransactOpts, rateLimitConfigArgs)
}
...
type TokenPoolFastTransferInboundRateLimitConsumedIterator struct {
	Event *TokenPoolFastTransferInboundRateLimitConsumed
...
func (it *TokenPoolFastTransferInboundRateLimitConsumedIterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(TokenPoolFastTransferInboundRateLimitConsumed)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
func (it *TokenPoolFastTransferInboundRateLimitConsumedIterator) Error() error {
	return it.fail
}

func (it *TokenPoolFastTransferInboundRateLimitConsumedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

type TokenPoolFastTransferInboundRateLimitConsumed struct {
	RemoteChainSelector uint64
	Token               common.Address
	Amount              *big.Int
	Raw                 types.Log
...
func (_TokenPool *TokenPoolFilterer) FilterFastTransferInboundRateLimitConsumed(opts *bind.FilterOpts, remoteChainSelector []uint64) (*TokenPoolFastTransferInboundRateLimitConsumedIterator, error) {
	...
	logs, sub, err := _TokenPool.contract.FilterLogs(opts, "FastTransferInboundRateLimitConsumed", remoteChainSelectorRule)
	if err != nil {
		return nil, err
	}
	return &TokenPoolFastTransferInboundRateLimitConsumedIterator{contract: _TokenPool.contract, event: "FastTransferInboundRateLimitConsumed", logs: logs, sub: sub}, nil
}

func (_TokenPool *TokenPoolFilterer) WatchFastTransferInboundRateLimitConsumed(opts *bind.WatchOpts, sink chan<- *TokenPoolFastTransferInboundRateLimitConsumed, remoteChainSelector []uint64) (event.Subscription, error) {
	...
	logs, sub, err := _TokenPool.contract.WatchLogs(opts, "FastTransferInboundRateLimitConsumed", remoteChainSelectorRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				event := new(TokenPoolFastTransferInboundRateLimitConsumed)
				if err := _TokenPool.contract.UnpackLog(event, "FastTransferInboundRateLimitConsumed", log); err != nil {
					return err
				}
				event.Raw = log
...
func (_TokenPool *TokenPoolFilterer) ParseFastTransferInboundRateLimitConsumed(log types.Log) (*TokenPoolFastTransferInboundRateLimitConsumed, error) {
	event := new(TokenPoolFastTransferInboundRateLimitConsumed)
	if err := _TokenPool.contract.UnpackLog(event, "FastTransferInboundRateLimitConsumed", log); err != nil {
		return nil, err
	}
...
type TokenPoolFastTransferOutboundRateLimitConsumedIterator struct {
	Event *TokenPoolFastTransferOutboundRateLimitConsumed
...
func (it *TokenPoolFastTransferOutboundRateLimitConsumedIterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(TokenPoolFastTransferOutboundRateLimitConsumed)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
func (it *TokenPoolFastTransferOutboundRateLimitConsumedIterator) Error() error {
	return it.fail
}

func (it *TokenPoolFastTransferOutboundRateLimitConsumedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

type TokenPoolFastTransferOutboundRateLimitConsumed struct {
	RemoteChainSelector uint64
	Token               common.Address
	Amount              *big.Int
	Raw                 types.Log
...
func (_TokenPool *TokenPoolFilterer) FilterFastTransferOutboundRateLimitConsumed(opts *bind.FilterOpts, remoteChainSelector []uint64) (*TokenPoolFastTransferOutboundRateLimitConsumedIterator, error) {
	...
	logs, sub, err := _TokenPool.contract.FilterLogs(opts, "FastTransferOutboundRateLimitConsumed", remoteChainSelectorRule)
	if err != nil {
		return nil, err
	}
	return &TokenPoolFastTransferOutboundRateLimitConsumedIterator{contract: _TokenPool.contract, event: "FastTransferOutboundRateLimitConsumed", logs: logs, sub: sub}, nil
}

func (_TokenPool *TokenPoolFilterer) WatchFastTransferOutboundRateLimitConsumed(opts *bind.WatchOpts, sink chan<- *TokenPoolFastTransferOutboundRateLimitConsumed, remoteChainSelector []uint64) (event.Subscription, error) {
	...
	logs, sub, err := _TokenPool.contract.WatchLogs(opts, "FastTransferOutboundRateLimitConsumed", remoteChainSelectorRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				event := new(TokenPoolFastTransferOutboundRateLimitConsumed)
				if err := _TokenPool.contract.UnpackLog(event, "FastTransferOutboundRateLimitConsumed", log); err != nil {
					return err
				}
				event.Raw = log
...
func (_TokenPool *TokenPoolFilterer) ParseFastTransferOutboundRateLimitConsumed(log types.Log) (*TokenPoolFastTransferOutboundRateLimitConsumed, error) {
	event := new(TokenPoolFastTransferOutboundRateLimitConsumed)
	if err := _TokenPool.contract.UnpackLog(event, "FastTransferOutboundRateLimitConsumed", log); err != nil {
		return nil, err
	}
...
func (TokenPoolFastTransferInboundRateLimitConsumed) Topic() common.Hash {
	return common.HexToHash("0xec8efbbe1188357e808975e80f998488a9c2747d618ffc39270836058a44428e")
}

func (TokenPoolFastTransferOutboundRateLimitConsumed) Topic() common.Hash {
...
type TokenPoolInterface interface {
	...
	FilterFastTransferInboundRateLimitConsumed(opts *bind.FilterOpts, remoteChainSelector []uint64) (*TokenPoolFastTransferInboundRateLimitConsumedIterator, error)

	WatchFastTransferInboundRateLimitConsumed(opts *bind.WatchOpts, sink chan<- *TokenPoolFastTransferInboundRateLimitConsumed, remoteChainSelector []uint64) (event.Subscription, error)

	ParseFastTransferInboundRateLimitConsumed(log types.Log) (*TokenPoolFastTransferInboundRateLimitConsumed, error)

	FilterFastTransferOutboundRateLimitConsumed(opts *bind.FilterOpts, remoteChainSelector []uint64) (*TokenPoolFastTransferOutboundRateLimitConsumedIterator, error)

	WatchFastTransferOutboundRateLimitConsumed(opts *bind.WatchOpts, sink chan<- *TokenPoolFastTransferOutboundRateLimitConsumed, remoteChainSelector []uint64) (event.Subscription, error)

	ParseFastTransferOutboundRateLimitConsumed(log types.Log) (*TokenPoolFastTransferOutboundRateLimitConsumed, error)
