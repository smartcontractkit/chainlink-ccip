...
func (_TokenPool *TokenPoolCaller) GetFee(opts *bind.CallOpts, arg0 common.Address, destChainSelector uint64, arg2 ClientEVM2AnyMessage, finality uint16, arg4 []byte) (GetFee,

	error) {
	var out []interface{}
	err := _TokenPool.contract.Call(opts, &out, "getFee", arg0, destChainSelector, arg2, finality, arg4)
...
func (_TokenPool *TokenPoolSession) GetFee(arg0 common.Address, destChainSelector uint64, arg2 ClientEVM2AnyMessage, finality uint16, arg4 []byte) (GetFee,

	error) {
	return _TokenPool.Contract.GetFee(&_TokenPool.CallOpts, arg0, destChainSelector, arg2, finality, arg4)
}

func (_TokenPool *TokenPoolCallerSession) GetFee(arg0 common.Address, destChainSelector uint64, arg2 ClientEVM2AnyMessage, finality uint16, arg4 []byte) (GetFee,
...
func (_TokenPool *TokenPoolTransactor) ApplyFinalityConfigUpdates(opts *bind.TransactOpts, minBlockConfirmation uint16, rateLimitConfigArgs []TokenPoolCustomFinalityRateLimitConfigArgs) (*types.Transaction, error) {
	return _TokenPool.contract.Transact(opts, "applyFinalityConfigUpdates", minBlockConfirmation, rateLimitConfigArgs)
}

func (_TokenPool *TokenPoolSession) ApplyFinalityConfigUpdates(minBlockConfirmation uint16, rateLimitConfigArgs []TokenPoolCustomFinalityRateLimitConfigArgs) (*types.Transaction, error) {
	return _TokenPool.Contract.ApplyFinalityConfigUpdates(&_TokenPool.TransactOpts, minBlockConfirmation, rateLimitConfigArgs)
}

func (_TokenPool *TokenPoolTransactorSession) ApplyFinalityConfigUpdates(minBlockConfirmation uint16, rateLimitConfigArgs []TokenPoolCustomFinalityRateLimitConfigArgs) (*types.Transaction, error) {
	return _TokenPool.Contract.ApplyFinalityConfigUpdates(&_TokenPool.TransactOpts, minBlockConfirmation, rateLimitConfigArgs)
}
...
type TokenPoolCustomFinalityMinimumBlockConfirmationUpdatedIterator struct {
	Event *TokenPoolCustomFinalityMinimumBlockConfirmationUpdated
...
func (it *TokenPoolCustomFinalityMinimumBlockConfirmationUpdatedIterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(TokenPoolCustomFinalityMinimumBlockConfirmationUpdated)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
func (it *TokenPoolCustomFinalityMinimumBlockConfirmationUpdatedIterator) Error() error {
	return it.fail
}

func (it *TokenPoolCustomFinalityMinimumBlockConfirmationUpdatedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

type TokenPoolCustomFinalityMinimumBlockConfirmationUpdated struct {
	MinBlockConfirmation uint16
	Raw                  types.Log
}

func (_TokenPool *TokenPoolFilterer) FilterCustomFinalityMinimumBlockConfirmationUpdated(opts *bind.FilterOpts) (*TokenPoolCustomFinalityMinimumBlockConfirmationUpdatedIterator, error) {

	logs, sub, err := _TokenPool.contract.FilterLogs(opts, "CustomFinalityMinimumBlockConfirmationUpdated")
	if err != nil {
		return nil, err
	}
	return &TokenPoolCustomFinalityMinimumBlockConfirmationUpdatedIterator{contract: _TokenPool.contract, event: "CustomFinalityMinimumBlockConfirmationUpdated", logs: logs, sub: sub}, nil
}

func (_TokenPool *TokenPoolFilterer) WatchCustomFinalityMinimumBlockConfirmationUpdated(opts *bind.WatchOpts, sink chan<- *TokenPoolCustomFinalityMinimumBlockConfirmationUpdated) (event.Subscription, error) {

	logs, sub, err := _TokenPool.contract.WatchLogs(opts, "CustomFinalityMinimumBlockConfirmationUpdated")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				event := new(TokenPoolCustomFinalityMinimumBlockConfirmationUpdated)
				if err := _TokenPool.contract.UnpackLog(event, "CustomFinalityMinimumBlockConfirmationUpdated", log); err != nil {
					return err
				}
				event.Raw = log
...
func (_TokenPool *TokenPoolFilterer) ParseCustomFinalityMinimumBlockConfirmationUpdated(log types.Log) (*TokenPoolCustomFinalityMinimumBlockConfirmationUpdated, error) {
	event := new(TokenPoolCustomFinalityMinimumBlockConfirmationUpdated)
	if err := _TokenPool.contract.UnpackLog(event, "CustomFinalityMinimumBlockConfirmationUpdated", log); err != nil {
		return nil, err
	}
...
func (TokenPoolCustomFinalityMinimumBlockConfirmationUpdated) Topic() common.Hash {
...
type TokenPoolInterface interface {
	...
	FilterCustomFinalityMinimumBlockConfirmationUpdated(opts *bind.FilterOpts) (*TokenPoolCustomFinalityMinimumBlockConfirmationUpdatedIterator, error)

	WatchCustomFinalityMinimumBlockConfirmationUpdated(opts *bind.WatchOpts, sink chan<- *TokenPoolCustomFinalityMinimumBlockConfirmationUpdated) (event.Subscription, error)

	ParseCustomFinalityMinimumBlockConfirmationUpdated(log types.Log) (*TokenPoolCustomFinalityMinimumBlockConfirmationUpdated, error)
