...
func (_TokenPool *TokenPoolTransactor) ApplyFinalityConfigUpdates(opts *bind.TransactOpts, finalityThreshold uint16, customFinalityTransferFeeBps uint16, maxAmountPerRequest *big.Int, rateLimitConfigArgs []TokenPoolCustomFinalityRateLimitConfigArgs) (*types.Transaction, error) {
	return _TokenPool.contract.Transact(opts, "applyFinalityConfigUpdates", finalityThreshold, customFinalityTransferFeeBps, maxAmountPerRequest, rateLimitConfigArgs)
}

func (_TokenPool *TokenPoolSession) ApplyFinalityConfigUpdates(finalityThreshold uint16, customFinalityTransferFeeBps uint16, maxAmountPerRequest *big.Int, rateLimitConfigArgs []TokenPoolCustomFinalityRateLimitConfigArgs) (*types.Transaction, error) {
	return _TokenPool.Contract.ApplyFinalityConfigUpdates(&_TokenPool.TransactOpts, finalityThreshold, customFinalityTransferFeeBps, maxAmountPerRequest, rateLimitConfigArgs)
}

func (_TokenPool *TokenPoolTransactorSession) ApplyFinalityConfigUpdates(finalityThreshold uint16, customFinalityTransferFeeBps uint16, maxAmountPerRequest *big.Int, rateLimitConfigArgs []TokenPoolCustomFinalityRateLimitConfigArgs) (*types.Transaction, error) {
	return _TokenPool.Contract.ApplyFinalityConfigUpdates(&_TokenPool.TransactOpts, finalityThreshold, customFinalityTransferFeeBps, maxAmountPerRequest, rateLimitConfigArgs)
}
...
type TokenPoolCustomFinalityTransferOutboundRateLimitConsumedIterator struct {
	Event *TokenPoolCustomFinalityTransferOutboundRateLimitConsumed
...
func (it *TokenPoolCustomFinalityTransferOutboundRateLimitConsumedIterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(TokenPoolCustomFinalityTransferOutboundRateLimitConsumed)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
func (it *TokenPoolCustomFinalityTransferOutboundRateLimitConsumedIterator) Error() error {
	return it.fail
}

func (it *TokenPoolCustomFinalityTransferOutboundRateLimitConsumedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

type TokenPoolCustomFinalityTransferOutboundRateLimitConsumed struct {
	RemoteChainSelector uint64
	Token               common.Address
	Amount              *big.Int
	Raw                 types.Log
...
func (_TokenPool *TokenPoolFilterer) FilterCustomFinalityTransferOutboundRateLimitConsumed(opts *bind.FilterOpts, remoteChainSelector []uint64) (*TokenPoolCustomFinalityTransferOutboundRateLimitConsumedIterator, error) {
	...
	logs, sub, err := _TokenPool.contract.FilterLogs(opts, "CustomFinalityTransferOutboundRateLimitConsumed", remoteChainSelectorRule)
	if err != nil {
		return nil, err
	}
	return &TokenPoolCustomFinalityTransferOutboundRateLimitConsumedIterator{contract: _TokenPool.contract, event: "CustomFinalityTransferOutboundRateLimitConsumed", logs: logs, sub: sub}, nil
}

func (_TokenPool *TokenPoolFilterer) WatchCustomFinalityTransferOutboundRateLimitConsumed(opts *bind.WatchOpts, sink chan<- *TokenPoolCustomFinalityTransferOutboundRateLimitConsumed, remoteChainSelector []uint64) (event.Subscription, error) {
	...
	logs, sub, err := _TokenPool.contract.WatchLogs(opts, "CustomFinalityTransferOutboundRateLimitConsumed", remoteChainSelectorRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				event := new(TokenPoolCustomFinalityTransferOutboundRateLimitConsumed)
				if err := _TokenPool.contract.UnpackLog(event, "CustomFinalityTransferOutboundRateLimitConsumed", log); err != nil {
					return err
				}
				event.Raw = log
...
func (_TokenPool *TokenPoolFilterer) ParseCustomFinalityTransferOutboundRateLimitConsumed(log types.Log) (*TokenPoolCustomFinalityTransferOutboundRateLimitConsumed, error) {
	event := new(TokenPoolCustomFinalityTransferOutboundRateLimitConsumed)
	if err := _TokenPool.contract.UnpackLog(event, "CustomFinalityTransferOutboundRateLimitConsumed", log); err != nil {
		return nil, err
	}
...
func (TokenPoolCustomFinalityTransferOutboundRateLimitConsumed) Topic() common.Hash {
...
type TokenPoolInterface interface {
	...
	FilterCustomFinalityTransferOutboundRateLimitConsumed(opts *bind.FilterOpts, remoteChainSelector []uint64) (*TokenPoolCustomFinalityTransferOutboundRateLimitConsumedIterator, error)

	WatchCustomFinalityTransferOutboundRateLimitConsumed(opts *bind.WatchOpts, sink chan<- *TokenPoolCustomFinalityTransferOutboundRateLimitConsumed, remoteChainSelector []uint64) (event.Subscription, error)

	ParseCustomFinalityTransferOutboundRateLimitConsumed(log types.Log) (*TokenPoolCustomFinalityTransferOutboundRateLimitConsumed, error)
