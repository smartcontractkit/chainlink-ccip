...
func (_TokenPool *TokenPoolFilterer) FilterLockedOrBurned(opts *bind.FilterOpts, sender []common.Address) (*TokenPoolLockedOrBurnedIterator, error) {
	...
	logs, sub, err := _TokenPool.contract.FilterLogs(opts, "LockedOrBurned", senderRule)
	if err != nil {
		return nil, err
	}
...
func (_TokenPool *TokenPoolFilterer) WatchLockedOrBurned(opts *bind.WatchOpts, sink chan<- *TokenPoolLockedOrBurned, sender []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _TokenPool.contract.WatchLogs(opts, "LockedOrBurned", senderRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
...
func (_TokenPool *TokenPoolFilterer) FilterReleasedOrMinted(opts *bind.FilterOpts, sender []common.Address, recipient []common.Address) (*TokenPoolReleasedOrMintedIterator, error) {
	...
	logs, sub, err := _TokenPool.contract.FilterLogs(opts, "ReleasedOrMinted", senderRule, recipientRule)
	if err != nil {
		return nil, err
	}
...
func (_TokenPool *TokenPoolFilterer) WatchReleasedOrMinted(opts *bind.WatchOpts, sink chan<- *TokenPoolReleasedOrMinted, sender []common.Address, recipient []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _TokenPool.contract.WatchLogs(opts, "ReleasedOrMinted", senderRule, recipientRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
...
type TokenPoolTokensConsumedIterator struct {
	Event *TokenPoolTokensConsumed
...
func (it *TokenPoolTokensConsumedIterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(TokenPoolTokensConsumed)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
func (it *TokenPoolTokensConsumedIterator) Error() error {
	return it.fail
}

func (it *TokenPoolTokensConsumedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

type TokenPoolTokensConsumed struct {
	Tokens *big.Int
	Raw    types.Log
}

func (_TokenPool *TokenPoolFilterer) FilterTokensConsumed(opts *bind.FilterOpts) (*TokenPoolTokensConsumedIterator, error) {

	logs, sub, err := _TokenPool.contract.FilterLogs(opts, "TokensConsumed")
	if err != nil {
		return nil, err
	}
	return &TokenPoolTokensConsumedIterator{contract: _TokenPool.contract, event: "TokensConsumed", logs: logs, sub: sub}, nil
}

func (_TokenPool *TokenPoolFilterer) WatchTokensConsumed(opts *bind.WatchOpts, sink chan<- *TokenPoolTokensConsumed) (event.Subscription, error) {

	logs, sub, err := _TokenPool.contract.WatchLogs(opts, "TokensConsumed")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				event := new(TokenPoolTokensConsumed)
				if err := _TokenPool.contract.UnpackLog(event, "TokensConsumed", log); err != nil {
					return err
				}
				event.Raw = log
...
func (_TokenPool *TokenPoolFilterer) ParseTokensConsumed(log types.Log) (*TokenPoolTokensConsumed, error) {
	event := new(TokenPoolTokensConsumed)
	if err := _TokenPool.contract.UnpackLog(event, "TokensConsumed", log); err != nil {
		return nil, err
	}
...
func (_TokenPool *TokenPool) ParseLog(log types.Log) (generated.AbigenLog, error) {
	...
	case _TokenPool.abi.Events["TokensConsumed"].ID:
		return _TokenPool.ParseTokensConsumed(log)
...
func (TokenPoolTokensConsumed) Topic() common.Hash {
...
type TokenPoolInterface interface {
	...
	FilterLockedOrBurned(opts *bind.FilterOpts, sender []common.Address) (*TokenPoolLockedOrBurnedIterator, error)

	WatchLockedOrBurned(opts *bind.WatchOpts, sink chan<- *TokenPoolLockedOrBurned, sender []common.Address) (event.Subscription, error)
	...
	FilterReleasedOrMinted(opts *bind.FilterOpts, sender []common.Address, recipient []common.Address) (*TokenPoolReleasedOrMintedIterator, error)

	WatchReleasedOrMinted(opts *bind.WatchOpts, sink chan<- *TokenPoolReleasedOrMinted, sender []common.Address, recipient []common.Address) (event.Subscription, error)
	...
	FilterTokensConsumed(opts *bind.FilterOpts) (*TokenPoolTokensConsumedIterator, error)

	WatchTokensConsumed(opts *bind.WatchOpts, sink chan<- *TokenPoolTokensConsumed) (event.Subscription, error)

	ParseTokensConsumed(log types.Log) (*TokenPoolTokensConsumed, error)
