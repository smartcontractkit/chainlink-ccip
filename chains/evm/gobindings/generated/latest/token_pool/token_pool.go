...
func (_TokenPool *TokenPoolTransactor) WithdrawFee(opts *bind.TransactOpts, feeTokens []common.Address, recipient common.Address) (*types.Transaction, error) {
	return _TokenPool.contract.Transact(opts, "withdrawFee", feeTokens, recipient)
}

func (_TokenPool *TokenPoolSession) WithdrawFee(feeTokens []common.Address, recipient common.Address) (*types.Transaction, error) {
	return _TokenPool.Contract.WithdrawFee(&_TokenPool.TransactOpts, feeTokens, recipient)
}

func (_TokenPool *TokenPoolTransactorSession) WithdrawFee(feeTokens []common.Address, recipient common.Address) (*types.Transaction, error) {
	return _TokenPool.Contract.WithdrawFee(&_TokenPool.TransactOpts, feeTokens, recipient)
}
