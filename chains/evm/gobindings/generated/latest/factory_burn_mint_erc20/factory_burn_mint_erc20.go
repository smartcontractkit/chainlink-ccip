...
func (_FactoryBurnMintERC20 *FactoryBurnMintERC20Transactor) SetHyperEVMLinker(opts *bind.TransactOpts, newLinker common.Address) (*types.Transaction, error) {
	return _FactoryBurnMintERC20.contract.Transact(opts, "setHyperEVMLinker", newLinker)
}

func (_FactoryBurnMintERC20 *FactoryBurnMintERC20Session) SetHyperEVMLinker(newLinker common.Address) (*types.Transaction, error) {
	return _FactoryBurnMintERC20.Contract.SetHyperEVMLinker(&_FactoryBurnMintERC20.TransactOpts, newLinker)
}

func (_FactoryBurnMintERC20 *FactoryBurnMintERC20TransactorSession) SetHyperEVMLinker(newLinker common.Address) (*types.Transaction, error) {
	return _FactoryBurnMintERC20.Contract.SetHyperEVMLinker(&_FactoryBurnMintERC20.TransactOpts, newLinker)
}
