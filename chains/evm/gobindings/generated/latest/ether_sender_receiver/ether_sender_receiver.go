...
func (_EtherSenderReceiver *EtherSenderReceiverCaller) GetCCVs(opts *bind.CallOpts, sourceChainSelector uint64) (GetCCVs,

	error) {
	var out []interface{}
	err := _EtherSenderReceiver.contract.Call(opts, &out, "getCCVs", sourceChainSelector)
...
func (_EtherSenderReceiver *EtherSenderReceiverSession) GetCCVs(sourceChainSelector uint64) (GetCCVs,

	error) {
	return _EtherSenderReceiver.Contract.GetCCVs(&_EtherSenderReceiver.CallOpts, sourceChainSelector)
}

func (_EtherSenderReceiver *EtherSenderReceiverCallerSession) GetCCVs(sourceChainSelector uint64) (GetCCVs,
