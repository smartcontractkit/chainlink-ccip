...
// PingPongDemoABI is the ABI for the PingPongDemo contract
...
// PingPongDemoBin is the bytecode for the PingPongDemo contract
...
// PingPongDemoContract is a local wrapper for PingPongDemo contract interactions
...
// NewPingPongDemoContract creates a new PingPongDemoContract wrapper
...
// SetCounterpart calls SetCounterpart on the contract
func (c *PingPongDemoContract) SetCounterpart(opts *bind.TransactOpts, args SetCounterpartArgs) (*types.Transaction, error) {
	return c.contract.Transact(opts, "SetCounterpart", args.CounterpartChainSelector, args.CounterpartAddress)
}

// SetCounterpartChainSelector calls SetCounterpartChainSelector on the contract
...
// SetCounterpartAddress calls SetCounterpartAddress on the contract
...
// SetPaused calls SetPaused on the contract
...
// SetOutOfOrderExecution calls SetOutOfOrderExecution on the contract
...
// StartPingPong calls StartPingPong on the contract
...
var SetCounterpart = contract.NewWrite(contract.WriteParams[SetCounterpartArgs, *PingPongDemoContract]{
	...
	CallContract: func(c *PingPongDemoContract, opts *bind.TransactOpts, args SetCounterpartArgs) (*types.Transaction, error) {
		return c.SetCounterpart(opts, args)
	},
})
...
var StartPingPong = contract.NewWrite(contract.WriteParams[struct{}, *PingPongDemoContract]{
	...
	ContractABI:     PingPongDemoABI,
	NewContract:     NewPingPongDemoContract,
	IsAllowedCaller: contract.OnlyOwner[*PingPongDemoContract, struct{}],
