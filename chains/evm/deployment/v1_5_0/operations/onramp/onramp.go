...
func NewWriteOnRampSetTokenTransferFeeConfig(c *evm_2_evm_onramp.EVM2EVMOnRamp) *cld_ops.Operation[contract.FunctionInput[SetTokenTransferFeeConfigInput], contract.WriteOutput, cldf_evm.Chain] {
	return contract.NewWrite(contract.WriteParams[SetTokenTransferFeeConfigInput, *evm_2_evm_onramp.EVM2EVMOnRamp]{
...
func NewReadOnRampGetTokenTransferFeeConfig(c *evm_2_evm_onramp.EVM2EVMOnRamp) *cld_ops.Operation[contract.FunctionInput[common.Address], evm_2_evm_onramp.EVM2EVMOnRampTokenTransferFeeConfig, cldf_evm.Chain] {
	return contract.NewRead(contract.ReadParams[common.Address, evm_2_evm_onramp.EVM2EVMOnRampTokenTransferFeeConfig, *evm_2_evm_onramp.EVM2EVMOnRamp]{
...
func NewReadOnRampStaticConfig(c *evm_2_evm_onramp.EVM2EVMOnRamp) *cld_ops.Operation[contract.FunctionInput[struct{}], evm_2_evm_onramp.EVM2EVMOnRampStaticConfig, cldf_evm.Chain] {
	return contract.NewRead(contract.ReadParams[struct{}, evm_2_evm_onramp.EVM2EVMOnRampStaticConfig, *evm_2_evm_onramp.EVM2EVMOnRamp]{
		Name:         "onramp:static-config",
		Version:      Version,
		Description:  "Reads the static config from the OnRamp 1.5.0 contract",
		ContractType: ContractType,
		Contract:     c,
		CallContract: func(onRamp *evm_2_evm_onramp.EVM2EVMOnRamp, opts *bind.CallOpts, args struct{}) (evm_2_evm_onramp.EVM2EVMOnRampStaticConfig, error) {
			return onRamp.GetStaticConfig(opts)
		},
	})
}

func NewReadOnRampDynamicConfig(c *evm_2_evm_onramp.EVM2EVMOnRamp) *cld_ops.Operation[contract.FunctionInput[struct{}], evm_2_evm_onramp.EVM2EVMOnRampDynamicConfig, cldf_evm.Chain] {
	return contract.NewRead(contract.ReadParams[struct{}, evm_2_evm_onramp.EVM2EVMOnRampDynamicConfig, *evm_2_evm_onramp.EVM2EVMOnRamp]{
		Name:         "onramp:dynamic-config",
		Version:      Version,
		Description:  "Reads the dynamic config from the OnRamp 1.5.0 contract",
		ContractType: ContractType,
		Contract:     c,
		CallContract: func(onRamp *evm_2_evm_onramp.EVM2EVMOnRamp, opts *bind.CallOpts, args struct{}) (evm_2_evm_onramp.EVM2EVMOnRampDynamicConfig, error) {
			return onRamp.GetDynamicConfig(opts)
		},
	})
}

func NewReadOnRampFeeTokenConfig(c *evm_2_evm_onramp.EVM2EVMOnRamp) *cld_ops.Operation[contract.FunctionInput[common.Address], evm_2_evm_onramp.EVM2EVMOnRampFeeTokenConfig, cldf_evm.Chain] {
	return contract.NewRead(contract.ReadParams[common.Address, evm_2_evm_onramp.EVM2EVMOnRampFeeTokenConfig, *evm_2_evm_onramp.EVM2EVMOnRamp]{
