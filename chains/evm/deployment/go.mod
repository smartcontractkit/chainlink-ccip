...
require (
	...
	github.com/smartcontractkit/chainlink-ccip v0.1.1-solana.0.20260127030153-a3880b809cd4
	github.com/smartcontractkit/chainlink-ccip/deployment v0.0.0-20260127030153-a3880b809cd4
