...
var ContractType cldf_deployment.ContractType = "BurnWithFromMintTokenPool"
...
var Deploy = contract.NewDeploy(contract.DeployParams[ConstructorArgs]{
	Name:             "burn_with_from_mint_token_pool:deploy",
	Version:          Version,
	Description:      "Deploys the BurnWithFromMintTokenPool contract",
