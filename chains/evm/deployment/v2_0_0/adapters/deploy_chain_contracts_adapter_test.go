	...
	importConfigContractMetadata = []datastore.ContractMetadata{
		{
			...
			Metadata: seq1_6.OnRampImportConfigSequenceOutput{
				DestChainCfgs: map[uint64]onramp_bindings.GetDestChainConfig{},
		...
		},
		{
			...
			Metadata: seq1_6.OffRampImportConfigSequenceOutput{
				SourceChainCfgs: map[uint64]offramp_bindings.OffRampSourceChainConfig{},
				...
				DynamicConfig: offramp_bindings.OffRampDynamicConfig{},
			},
		},
	}
)
