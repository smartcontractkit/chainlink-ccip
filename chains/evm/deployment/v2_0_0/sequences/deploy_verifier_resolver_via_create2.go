...
func validateQualifier(contractType datastore.ContractType, qualifier string) error {
	...
	lombardVerifierQualifier := versioned_verifier_resolver.LombardVerifierResolverType.String()
	cctpVerifierQualifier := versioned_verifier_resolver.CCTPVerifierResolverType.String()
