...
import (
	...
	gobindings "github.com/smartcontractkit/chainlink-ccip/chains/evm/gobindings/generated/v2_0_0/burn_mint_token_pool"
...
var Deploy = contract.NewDeploy(contract.DeployParams[ConstructorArgs]{
	...
	ContractMetadata: gobindings.BurnMintTokenPoolMetaData,
	BytecodeByTypeAndVersion: map[string]contract.Bytecode{
		cldf_deployment.NewTypeAndVersion(ContractType, *Version).String(): {
			EVM: common.FromHex(gobindings.BurnMintTokenPoolMetaData.Bin),
		},
	},
