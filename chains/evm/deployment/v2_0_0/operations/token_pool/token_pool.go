...
func (c *TokenPoolContract) SetAllowedFinalityConfig(opts *bind.TransactOpts, args [4]byte) (*types.Transaction, error) {
...
func (c *TokenPoolContract) SetDynamicConfig(
	...
	return c.contract.Transact(opts, "setDynamicConfig", router, rateLimitAdmin, feeAdmin, pauseAdmin)
}
...
func (c *TokenPoolContract) GetDynamicConfig(opts *bind.CallOpts) (GetDynamicConfigResult, error) {
	...
	outstruct.PauseAdmin = *abi.ConvertType(out[3], new(common.Address)).(*common.Address)
...
func (c *TokenPoolContract) GetCurrentRateLimiterState(opts *bind.CallOpts, remoteChainSelector uint64, fastFinality bool) (GetCurrentRateLimiterStateResult, error) {
	var out []any
	err := c.contract.Call(opts, &out, "getCurrentRateLimiterState", remoteChainSelector, fastFinality)
...
func (c *TokenPoolContract) GetAllowedFinalityConfig(opts *bind.CallOpts) ([4]byte, error) {
	var out []any
...
func (c *TokenPoolContract) GetTokenTransferFeeConfig(opts *bind.CallOpts, arg0 common.Address, destChainSelector uint64, arg2 [4]byte, arg3 []byte) (TokenTransferFeeConfig, error) {
	var out []any
...
var SetAllowedFinalityConfig = contract.NewWrite(contract.WriteParams[[4]byte, *TokenPoolContract]{
	...
	IsAllowedCaller: contract.OnlyOwner[*TokenPoolContract, [4]byte],
...
var SetDynamicConfig = contract.NewWrite(contract.WriteParams[SetDynamicConfigArgs, *TokenPoolContract]{
	...
	CallContract: func(
		...
		return c.SetDynamicConfig(opts, args.Router, args.RateLimitAdmin, args.FeeAdmin, args.PauseAdmin)
	},
})
...
var GetCurrentRateLimiterState = contract.NewRead(contract.ReadParams[GetCurrentRateLimiterStateArgs, GetCurrentRateLimiterStateResult, *TokenPoolContract]{
	...
	CallContract: func(c *TokenPoolContract, opts *bind.CallOpts, args GetCurrentRateLimiterStateArgs) (GetCurrentRateLimiterStateResult, error) {
		return c.GetCurrentRateLimiterState(opts, args.RemoteChainSelector, args.FastFinality)
	},
})

var GetAllowedFinalityConfig = contract.NewRead(contract.ReadParams[struct{}, [4]byte, *TokenPoolContract]{
	Name:         "token-pool:get-allowed-finality-config",
	Version:      Version,
	Description:  "Calls getAllowedFinalityConfig on the contract",
	ContractType: ContractType,
	NewContract:  NewTokenPoolContract,
	CallContract: func(c *TokenPoolContract, opts *bind.CallOpts, args struct{}) ([4]byte, error) {
