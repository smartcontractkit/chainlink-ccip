...
var ContractType cldf_deployment.ContractType = "BurnMintWithExternalMinterTokenPool"
...
var Deploy = contract.NewDeploy(contract.DeployParams[ConstructorArgs]{
	Name:             "burn_mint_with_external_minter_token_pool:deploy",
	Version:          Version,
	Description:      "Deploys the BurnMintWithExternalMinterTokenPool contract",
	ContractMetadata: burn_mint_with_external_minter_token_pool.BurnMintWithExternalMinterTokenPoolMetaData,
	BytecodeByTypeAndVersion: map[string]contract.Bytecode{
		cldf_deployment.NewTypeAndVersion(ContractType, *Version).String(): {
			EVM: common.FromHex(burn_mint_with_external_minter_token_pool.BurnMintWithExternalMinterTokenPoolBin),
		},
	},
