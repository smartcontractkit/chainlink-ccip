...
contract AdvancedPoolHooksExtractor is IExtractor {
  ...
  function _extractPreflightCheck(
    ...
    result[6] = IPolicyEngine.Parameter(PARAM_BLOCK_CONFIRMATION_REQUESTED, abi.encode(blockConfirmationsRequested));
  ...
  function _extractPostflightCheck(
    ...
    result[5] = IPolicyEngine.Parameter(PARAM_BLOCK_CONFIRMATION_REQUESTED, abi.encode(blockConfirmationsRequested));
