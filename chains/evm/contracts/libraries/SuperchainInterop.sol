...
library SuperchainInterop {
  // The custom event used to relay messages over superchain.
  ...
  // Exec report data used for OffRampOverSuperchainInterop message execution.
  struct ExecutionReport {
    // The complete log data of the CCIPSuperchainMessageSent event.
