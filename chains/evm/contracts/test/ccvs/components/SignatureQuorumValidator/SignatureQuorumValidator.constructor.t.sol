...
contract SignatureQuorumValidator_constructor is SignatureValidatorSetup {
  function test_constructor_ForkedChainDetection() public {
    ...
    SignatureQuorumValidator.SignatureConfig[] memory updates = _createUpdate(SOURCE_CHAIN_SELECTOR, testSigners, 1);
    verifier.applySignatureConfigs(new uint64[](0), updates);
    ...
    verifier.validateSignatures(SOURCE_CHAIN_SELECTOR, testHash, signature);
  }
}
