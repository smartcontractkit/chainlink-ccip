...
contract LombardVerifier_setAllowedFinalityConfig is LombardVerifierSetup {
  function test_setAllowedFinalityConfig() public {
    ...
    s_lombardVerifier.setAllowedFinalityConfig(newFinality);
    assertEq(s_lombardVerifier.getAllowedFinalityConfig(), newFinality);
  }
  ...
  function test_setAllowedFinalityConfig_RevertWhen_OnlyCallableByOwner() public {
    ...
    s_lombardVerifier.setAllowedFinalityConfig(FinalityCodec._encodeBlockDepth(1));
  }
}
