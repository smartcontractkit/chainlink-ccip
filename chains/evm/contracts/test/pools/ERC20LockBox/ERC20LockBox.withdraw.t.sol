...
contract ERC20LockBox_withdraw is ERC20LockBoxSetup {
  ...
  function test_withdraw_PartialAmount() public {
    ...
    s_erc20LockBox.withdraw(0, withdrawAmount, s_recipient);
  ...
  function test_withdraw_RevertWhen_Unauthorized() public {
    uint256 amount = 1000e18;
    _depositTokens(amount);
  ...
  function test_withdraw_RevertWhen_RecipientCannotBeZeroAddress() public {
    ...
    s_erc20LockBox.withdraw(0, amount, address(0));
  }
  ...
  function test_withdraw_RevertWhen_TokenAmountCannotBeZero() public {
    ...
    s_erc20LockBox.withdraw(0, 0, s_recipient);
  }
  ...
  function test_withdraw_RevertWhen_UnsupportedChainSelector() public {
    uint256 amount = 1000e18;
    _depositTokens(amount);

    vm.startPrank(s_allowedCaller);
    vm.expectRevert(abi.encodeWithSelector(ERC20LockBox.UnsupportedChainSelector.selector, uint64(777)));

    s_erc20LockBox.withdraw(777, amount, s_recipient);
  }
}
