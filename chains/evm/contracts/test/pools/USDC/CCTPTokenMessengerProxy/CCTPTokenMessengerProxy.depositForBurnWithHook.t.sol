...
contract CCTPTokenMessengerProxy_depositForBurnWithHook is CCTPTokenMessengerProxySetup {
  function test_depositForBurnWithHook() public {
    ...
    s_cctpTokenMessengerProxy.depositForBurnWithHook(
      BURN_AMOUNT,
      DESTINATION_DOMAIN,
      s_mintRecipient,
      address(s_USDCToken),
  ...
  function test_depositForBurnWithHook_RevertWhen_UnauthorizedCaller() public {
    ...
    s_cctpTokenMessengerProxy.depositForBurnWithHook(0, 0, bytes32(0), address(0), bytes32(0), 0, 0, bytes(""));
  }
}
