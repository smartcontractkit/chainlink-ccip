...
contract LombardTokenPool_constructor is Test {
  ...
  MockVerifierResolver internal s_resolver;
  ...
  function setUp() public {
    ...
    s_resolver = new MockVerifierResolver();
  }

  function test_constructor() public {
    LombardTokenPool pool = new LombardTokenPool(s_token, address(s_resolver), address(0), RMN, ROUTER, 18);
