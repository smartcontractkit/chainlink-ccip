...
contract AdvancedPoolHooks_applyAllowListUpdates is TokenPoolSetup {
  ...
  function setUp() public virtual override {
    ...
    s_advancedPoolHooks = new AdvancedPoolHooks(s_allowedSenders, 0, address(0));
  ...
  function test_applyAllowListUpdates_RevertWhen_AllowListNotEnabled() public {
    AdvancedPoolHooks hooksWithoutAllowList = new AdvancedPoolHooks(new address[](0), 0, address(0));
