...
There are 5 chain families that already supported CCIP v1: EVM, Solana, Aptos, Sui and TON. All net-new implementations do not need to support any legacy v1 support like IPoolV1 (the legacy TokenPool interface) or legacy ExtraArgs. When IPoolV2 is mentioned, it means the CCIP v2 pool interface, even on net-new chains.
