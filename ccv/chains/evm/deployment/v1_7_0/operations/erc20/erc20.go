...
var BalanceOf = contract.NewRead(contract.ReadParams[common.Address, *big.Int, *erc20_bindings.ERC20]{
	Name:         "erc20:balance-of",
	Version:      Version,
	Description:  "Returns the ERC20 balance for an account",
	ContractType: ContractType,
	NewContract:  erc20_bindings.NewERC20,
	CallContract: func(token *erc20_bindings.ERC20, opts *bind.CallOpts, account common.Address) (*big.Int, error) {
