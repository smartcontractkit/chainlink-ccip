...
func (_MockE2ELBTCTokenPool *MockE2ELBTCTokenPoolTransactor) SetMinBlockConfirmation(opts *bind.TransactOpts, minBlockConfirmations uint16) (*types.Transaction, error) {
	return _MockE2ELBTCTokenPool.contract.Transact(opts, "setMinBlockConfirmation", minBlockConfirmations)
}

func (_MockE2ELBTCTokenPool *MockE2ELBTCTokenPoolSession) SetMinBlockConfirmation(minBlockConfirmations uint16) (*types.Transaction, error) {
	return _MockE2ELBTCTokenPool.Contract.SetMinBlockConfirmation(&_MockE2ELBTCTokenPool.TransactOpts, minBlockConfirmations)
}

func (_MockE2ELBTCTokenPool *MockE2ELBTCTokenPoolTransactorSession) SetMinBlockConfirmation(minBlockConfirmations uint16) (*types.Transaction, error) {
	return _MockE2ELBTCTokenPool.Contract.SetMinBlockConfirmation(&_MockE2ELBTCTokenPool.TransactOpts, minBlockConfirmations)
}
