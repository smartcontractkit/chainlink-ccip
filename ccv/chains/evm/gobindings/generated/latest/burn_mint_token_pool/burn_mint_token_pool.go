...
func (_BurnMintTokenPool *BurnMintTokenPoolTransactor) SetMinBlockConfirmation(opts *bind.TransactOpts, minBlockConfirmations uint16) (*types.Transaction, error) {
	return _BurnMintTokenPool.contract.Transact(opts, "setMinBlockConfirmation", minBlockConfirmations)
}

func (_BurnMintTokenPool *BurnMintTokenPoolSession) SetMinBlockConfirmation(minBlockConfirmations uint16) (*types.Transaction, error) {
	return _BurnMintTokenPool.Contract.SetMinBlockConfirmation(&_BurnMintTokenPool.TransactOpts, minBlockConfirmations)
}

func (_BurnMintTokenPool *BurnMintTokenPoolTransactorSession) SetMinBlockConfirmation(minBlockConfirmations uint16) (*types.Transaction, error) {
	return _BurnMintTokenPool.Contract.SetMinBlockConfirmation(&_BurnMintTokenPool.TransactOpts, minBlockConfirmations)
}
