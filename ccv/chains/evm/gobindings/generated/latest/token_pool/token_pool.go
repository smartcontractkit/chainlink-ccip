...
func (_TokenPool *TokenPoolTransactor) SetDynamicConfig(opts *bind.TransactOpts, router common.Address, rateLimitAdmin common.Address, feeAggregator common.Address) (*types.Transaction, error) {
	return _TokenPool.contract.Transact(opts, "setDynamicConfig", router, rateLimitAdmin, feeAggregator)
}

func (_TokenPool *TokenPoolSession) SetDynamicConfig(router common.Address, rateLimitAdmin common.Address, feeAggregator common.Address) (*types.Transaction, error) {
	return _TokenPool.Contract.SetDynamicConfig(&_TokenPool.TransactOpts, router, rateLimitAdmin, feeAggregator)
}

func (_TokenPool *TokenPoolTransactorSession) SetDynamicConfig(router common.Address, rateLimitAdmin common.Address, feeAggregator common.Address) (*types.Transaction, error) {
	return _TokenPool.Contract.SetDynamicConfig(&_TokenPool.TransactOpts, router, rateLimitAdmin, feeAggregator)
}
...
func (_TokenPool *TokenPoolTransactor) WithdrawFeeTokens(opts *bind.TransactOpts, feeTokens []common.Address) (*types.Transaction, error) {
	return _TokenPool.contract.Transact(opts, "withdrawFeeTokens", feeTokens)
}

func (_TokenPool *TokenPoolSession) WithdrawFeeTokens(feeTokens []common.Address) (*types.Transaction, error) {
	return _TokenPool.Contract.WithdrawFeeTokens(&_TokenPool.TransactOpts, feeTokens)
}

func (_TokenPool *TokenPoolTransactorSession) WithdrawFeeTokens(feeTokens []common.Address) (*types.Transaction, error) {
	return _TokenPool.Contract.WithdrawFeeTokens(&_TokenPool.TransactOpts, feeTokens)
}
