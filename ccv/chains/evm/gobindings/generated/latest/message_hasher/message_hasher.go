...
type ClientGenericExtraArgsV3 struct {
	Ccvs           []ClientCCV
...
func (_MessageHasher *MessageHasherCaller) EncodeGenericExtraArgsV3(opts *bind.CallOpts, extraArgs ClientGenericExtraArgsV3) ([]byte, error) {
	var out []interface{}
...
func (_MessageHasher *MessageHasherSession) EncodeGenericExtraArgsV3(extraArgs ClientGenericExtraArgsV3) ([]byte, error) {
	return _MessageHasher.Contract.EncodeGenericExtraArgsV3(&_MessageHasher.CallOpts, extraArgs)
}

func (_MessageHasher *MessageHasherCallerSession) EncodeGenericExtraArgsV3(extraArgs ClientGenericExtraArgsV3) ([]byte, error) {
	return _MessageHasher.Contract.EncodeGenericExtraArgsV3(&_MessageHasher.CallOpts, extraArgs)
}
...
type MessageHasherInterface interface {
	...
	EncodeGenericExtraArgsV3(opts *bind.CallOpts, extraArgs ClientGenericExtraArgsV3) ([]byte, error)
