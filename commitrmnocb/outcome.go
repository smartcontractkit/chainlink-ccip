...
// ReportTransmissionFailed to signify we stop checking for updates and start a new report generation phase. If no update
// is detected, and we haven't exhausted our check attempts, output ReportInFlight to signify that we should
