...
// Type aliases so view code can use views.Call and views.CallResult.
type Call = orchestrator.Call
type CallResult = orchestrator.CallResult
...
type ViewContext struct {
	...
	Metadata      []byte // Optional per-chain metadata
	Qualifier     string // e.g., "default", "TEST", "MIXTEST"

	// Call orchestrator for making RPC calls (chain-family specific)
