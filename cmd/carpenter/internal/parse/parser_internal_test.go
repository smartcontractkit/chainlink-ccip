...
func Test_ParseLine_Mixed(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			expected: &Data{
				LoggerName:     "CCIPCommitPlugin.evm.90000001.909606746561742123.0x4c0c911d212a458359ff6064c6e843351bc10a5b",
				Level:          "INFO",
				Timestamp:      mustParseCustomLayout(t, "2025-01-20T13:44:15.033+0200"),
				Caller:         "merkleroot/outcome.go:47",
				SequenceNumber: 3,
				OCRPhase:       "otcm",
