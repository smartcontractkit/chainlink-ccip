...
var _ shared.PluginProcessor[dt.Query, dt.Observation, dt.Outcome] = &ContractDiscoveryProcessor{}
...
func (cdp *ContractDiscoveryProcessor) ValidateObservation(
	_ dt.Outcome, _ dt.Query, _ shared.AttributedObservation[dt.Observation],
) error {
...
func (cdp *ContractDiscoveryProcessor) Outcome(
	_ dt.Outcome, _ dt.Query, aos []shared.AttributedObservation[dt.Observation],
) (dt.Outcome, error) {
