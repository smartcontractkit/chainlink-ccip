...
type ExecuteOffchainConfig struct {
	...
	// SolanaChainWriterConfigVersion is a feature flag to specify which version of Solana ChainWriter configs to initialize the
	// plugin with.
	//
	// Deprecated: this feature flag is no longer needed since only the latest version of the Solana ChainWriter config is used
