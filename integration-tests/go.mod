...
require (
	...
	github.com/smartcontractkit/chainlink-ccip v0.1.1-solana.0.20251021160343-2672b2089213
	...
	github.com/smartcontractkit/chainlink-ccip/deployment v0.0.0-20251021160343-2672b2089213
