...
require (
	...
	github.com/smartcontractkit/chainlink-ccip v0.1.1-solana.0.20251029114206-bd3d8b1b8d2a
	...
	github.com/smartcontractkit/chainlink-ccip/deployment v0.0.0-20251029114206-bd3d8b1b8d2a
