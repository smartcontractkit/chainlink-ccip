...
require (
	...
	github.com/smartcontractkit/chainlink-ccip/deployment v0.0.0-20260219205039-254efa2041d3
...
require (
	github.com/smartcontractkit/chainlink-ccip/ccv/chains/evm v0.0.0-20260219205039-254efa2041d3
