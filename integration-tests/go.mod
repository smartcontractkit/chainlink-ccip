...
require (
	...
	github.com/smartcontractkit/chainlink-ccip/deployment v0.0.0-20260228204201-2c6af2b72fa1
...
require (
	github.com/smartcontractkit/chainlink-ccip/ccv/chains/evm v0.0.0-20260228203345-70388b2b23a1
