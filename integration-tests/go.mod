...
require (
	...
	github.com/smartcontractkit/chainlink-ccip v0.1.1-solana.0.20251103193049-9f70bcf47551
	...
	github.com/smartcontractkit/chainlink-ccip/deployment v0.0.0-20251103193049-9f70bcf47551
