...
require (
	...
	github.com/smartcontractkit/chainlink-ccip v0.1.1-solana.0.20251023123408-ae4fdca50598
	...
	github.com/smartcontractkit/chainlink-ccip/deployment v0.0.0-20251021182606-ee6ba95227d7
