...
require (
	...
	github.com/smartcontractkit/chainlink-ccip v0.1.1-solana.0.20260312191806-eeeeecd4e4f2
	...
	github.com/smartcontractkit/chainlink-ccip/deployment v0.0.0-20260312191806-eeeeecd4e4f2
...
require (
	github.com/smartcontractkit/chainlink-ccip/ccv/chains/evm v0.0.0-20260312191806-eeeeecd4e4f2
