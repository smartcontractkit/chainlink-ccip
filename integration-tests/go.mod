...
require (
	...
	github.com/smartcontractkit/chainlink-ccip v0.1.1-solana.0.20251124115649-9a8a427685f8
	...
	github.com/smartcontractkit/chainlink-ccip/deployment v0.0.0-20251124115649-9a8a427685f8
