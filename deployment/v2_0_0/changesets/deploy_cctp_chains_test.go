...
func TestDeployCCTPChains_Apply_TwoChainSuccess_WithRemoteChains(t *testing.T) {
	...
	cs := v2_0_0_changesets.DeployCCTPChains(cctpChainRegistry, mcmsRegistry)
	out, err := cs.Apply(e, v2_0_0_changesets.DeployCCTPChainsConfig{
		Chains: map[uint64]v2_0_0_changesets.CCTPChainConfig{
			selA: {
				USDCType:         adapters.Canonical,
				TokenMessengerV2: "0x9999999999999999999999999999999999999999",
...
func TestDeployCCTPChains_Apply_ConfigureSequenceError(t *testing.T) {
	...
	cs := v2_0_0_changesets.DeployCCTPChains(cctpChainRegistry, mcmsRegistry)
	_, err = cs.Apply(e, v2_0_0_changesets.DeployCCTPChainsConfig{
		Chains: map[uint64]v2_0_0_changesets.CCTPChainConfig{
			chainSelector: {
				USDCType:         adapters.Canonical,
				TokenMessengerV2: "0x9999999999999999999999999999999999999999",
