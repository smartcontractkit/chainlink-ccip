...
// A chain dropped here falls out of ALL downstream consensus computations (messages, roots, hashes,
// token data), so the drop reason is counted via ccip_exec_consensus_dropped.
