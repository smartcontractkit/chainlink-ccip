...
// chain and allow minting on the destination chain. The main goal of this package is to match
// USDC token transfers in each CCIP message to the CCTPv2 attestation for this USDC transfer.
//
// # CCTPv2 vs CCTPv1
//
