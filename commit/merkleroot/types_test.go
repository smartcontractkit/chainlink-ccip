	...
	tests := []struct {
		...
		},
		{
			...
			observation: Observation{
				...
				OnRampMaxSeqNums:   []plugintypes.SeqNumChain{},
				OffRampNextSeqNums: []plugintypes.SeqNumChain{},
				RMNRemoteConfig:    rmntypes.RemoteConfig{RmnReportVersion: cciptypes.Bytes32{1}},
				FChain:             map[cciptypes.ChainSelector]int{},
			},
			expected: false,
		},
	...
	tests := []struct {
		...
		},
		{
			...
			expected: aggregatedObservation{
				...
				RMNRemoteConfigs:   []rmntypes.RemoteConfig{{RmnReportVersion: cciptypes.Bytes32{1}}},
				FChain:             map[cciptypes.ChainSelector][]int{1: {1}},
				RMNEnabledChains:   map[cciptypes.ChainSelector][]bool{},
			},
		},
			...
			observations: []plugincommon.AttributedObservation[Observation]{
				...
				},
				{
					Observation: Observation{
						...
						RMNRemoteConfig:    rmntypes.RemoteConfig{RmnReportVersion: cciptypes.Bytes32{2}},
